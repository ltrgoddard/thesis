...
> \singlespacing ‘Being a poet is a form of admitted self-recognition
> and self-description inside a schedule of professions and roles within
> the social categories of a community and the nomenclatures for
...
extended discussion of the poetry, while Ian Brinton’s essay collections
*A Manner of Utterance* (2009) and *For the Future* (2016) collect a
number of articles on the same subject. Further analysis is provided by
dedicated editions of the journals *Jacket* (24, 2002), *QUID* (17,
2006) and *Glossator* (2, 2010), while doctoral theses focusing
primarily on Prynne have been produced by N.R. Burrell, D.S. Marriott,
Anthony Mellors, Rachel Campbell-Johnston, Birgitta Johansson,
Sutherland, Ryan Dobran and Matthew Hall.[^3]
...
has gone before.[^5] It would obviously be optimistic to expect a large
body of rigorously historicist scholarship to have already emerged
around Prynne, when book-length studies of his poetry still number in
...
as ‘\[p\]erhaps the most influential account’ of the shift.[^28]
Sutherland himself disagrees at length with the specifics of these
accounts, but he does not dispute the substantive point that a change
took place in Prynne’s work, arguing instead that it can be detected as
early as *The White Stones* (1969). Whether or not this second shift in
Prynne’s work is attributed directly to his loss of contact with Olson
and the latter’s subsequent death, and whether it occurs neatly between
*The White Stones* and *Brass* or runs like a fault line through the
former collection, it has the effect of relegating the work of the early
1960s from the position of subordinate term in a binary hierarchy to
effective invisibility within a model of Prynne’s career that is
formally ternary but is in critical practice still composed of two
parts: early and mature.[^29] More recent investigations into what has
been described as Prynne’s ‘late style’—notably a special edition of the
journal *Hix Eros* compiled following a symposium on the topic in
2013—threaten to push this work even further into obscurity.[^30]
...
has described the poetic climate during his school and college years as
‘a kind of wasteland’, and it would of course be misleading to insist
that his intellectual relationship with, say, Charles Tomlinson is as
significant to the development of his poetry and prose as his
relationships with Olson and, later, Ed Dorn.[^32] Nevertheless, it is
important to recognise the extent to which the prevailing scholarly
focus on the transatlantic bridge represented by Prynne’s contact with
the latter two figures is conditioned by what are essentially archival
contingencies—notably, the presence of hundreds of letters from Prynne
to Olson and Dorn in a well-known and easily accessible collection at
the University of Connecticut.[^33] It is possible to hazard a general
law of modern literary history, according to which physical distance
between poets—with its concomitants, greater reliance on written
correspondence and a stronger tendency to prize and therefore preserve
letters received—tends to promote the visibility of the relationship in
subsequent scholarship. The opposite case clearly applies to Davie, with
whom Prynne must have had dozens of meetings which have left no written
trace, aside from the brief reference to ‘conversations with J.H.
Prynne’ in the acknowledgements to Davie’s 1964 book on Ezra Pound.[^34]
...
in distancing the speaker from his grandmother, playing into the poem’s
broader purpose: to allow Davie, well-known poet and Cambridge don, to
celebrate his provincial origins while reassuring his audience that he
has transcended them, and crucially that they do not exert any
involuntary influence on his poetic work. ‘Housekeeping’ is definitely
nostalgic and potentially ironic. Does it also infringe Davie’s third
ban, on the use of literary allusions? According to Davie’s own comments
during a 1963 reading at the University of Cincinnati, it does.
Introducing the poem, he reveals that it ‘has quite a close relation to
a specific poem among those \[…\] by Boris Pasternak, which I was
translating at the time.’[^45] Davie is referring to the poems which
form the concluding section of Pasternak’s novel *Doctor Zhivago*, of
which his translation was published in 1965.[^46] Far from being an
invisible link, and thus not strictly an allusion at all, this relation
is presumed by Davie to be visible (with some prompting) to his
audience: ‘Those of you who know Pasternak’s *Doctor Zhivago*, with the
poems at the end in the of course inadequate translation, may like to
ask yourselves which of Pasternak’s poems it was that sparked this one
off as far as I’m concerned.’[^47] ‘Housekeeping’ is certainly not
representative of *Events & Wisdoms* as a whole, but neither is it
completely anomalous, and the fact that it fails so obviously to conform
to what is presumably Davie’s own description of the volume—a collection
which ‘eschews for the most part the use of irony, nostalgia, and
literary allusions’—suggests a real gap between his ambitions and his
poetic achievements in this period. This analysis is confirmed in
startlingly blunt terms by a November 1958 entry in Davie’s personal
journal. Having recounted a conversation with George MacBeth in which
‘modern Franco-American poetic’ was dismissed, Davie makes the
ambivalent nature of his own position clear: ‘I come round to thinking
that \[…\] many of the sincerely self-professed champions of poetry are
in fact its worst enemies. My own prolonged schizophrenia—between
\[Yvor\] Winters on the one hand, Pound & Tomlinson on the other—at this
point enters on a crucial phrase.’[^48]
...
is rife. Look at Gunn.’ The collocation with Thom Gunn is particularly
...
carry a review \[…\]—pressures inherited that I can’t side-step.’[^49]
It is not immediately obvious what Prynne means by ‘muscle-bound
...
musculature of most English writers of verse’.[^50] It is perhaps
...
one of simultaneous fascination and alienation.[^51] In the sequence’s
...
| And envy you out of England.’[^52] A further poem, added to the
...
British, one sympathizes.’[^53] It seems possible that Prynne’s
...
academic of such intelligence and standing as him.’[^55] While this
...
an idiot.[^56] Prynne’s next letter to Dorn, in July, helpfully
...
small conviction he can command.’[^57] He admits that Davie ‘has visions
...
what is true of the public context in which we live.’[^58] It is odd to
...
doubt”, “I suppose”, “of course”, “almost”, “perhaps”’.[^59] This is
...
outside of the | shopping-bag’.[^60] When we encounter the ‘inert
...
much difficulty.’[^62] Discussing the same subject with Dorn in
...
published there and know the man in question \[Colin Franklin\].’[^63]
...
Guardian*.’[^64] The tone here is like a less direct and militaristic
...
‘with you as general, the boys could move right into control.’[^65]
...
> a *New Statesman* review of Spender’s new and worthless book.[^66]
...
new in America at this time, but I am working steadily at him’.[^68] At
...
of distance’.[^69] This ambivalence is maintained throughout the decade.
...
well.’[^70] Yet when Davie makes his momentous move to the United States
...
Cal.’[^71] Prynne’s ambivalence towards Davie was described above as
...
other’s verse.’[^72] That Prynne enjoyed a similarly free relationship
...
their characterisation as ‘middlebrow’.[^74] The anthology’s
...
‘journalist in verse’.[^75] Aside from some similarly dismissive
...
manner’, though he is kept in his place as ‘a good but minor poet’.[^76]
...
objective values in our criticism.’[^77]
...
to leave it behind.[^78] Yet both positions are complicated by a further
...
throw down *any* safeguard.’[^79] It is Enright’s piece which deals the
...
*milieu* and trying to push beyond it.[^81]
...
the attention of his then publishers’.[^82] Prynne’s letter to Dorn of
...
he refused to do the same (or more) for his own student.[^83] The second
...
Stevens.’[^84] Broadcasting on the Third Programme was in fact a
...
(Corpus Christi) on Martin Heidegger.[^85] Nevertheless, it seems likely
...
translation of the *Odyssey*.[^86]) The last of Davie’s potential
...
publication of selected interviews in a 1966 volume edited by Orr.[^87]
...
> seems very foreign to me, I think.[^88]
...
other.’[^89] In a roughly contemporaneous letter to the little magazine
...
(the logical successor to Auden’s)’.[^90] This last statement offers a
...
door-nail would be, given any decent chance.’[^91] It is instructive to
...
set the tone for his subsequent work.[^92] Prynne and Tomlinson both
...
in a trick they hoped to play on their supporters.’[^93] Just as Amis
...
Circumstance*.[^94] That Prynne decided, from the late 1960s, to forego
...
and worthy of study.[^95] As was demonstrated at the beginning of this
...
F.R. Leavis and his wife Queenie.’[^96] Prynne and F.R. Leavis are very
...
‘followers’, for want of a better term.[^97] Responding to a piece by
...
and my time in the UK still adds up to far less than half my life.’[^98]
...
revised edition of the *Oxford Companion to Modern Poetry*:
...
three in the year 1948 alone.[^100] A memoir written by one of the three
...
exams.[^101] If Leavis was a distinct presence in Prynne’s schooling,
...
to help him with translations of some poetic texts.’[^102] In terms of
...
of Reading and York.[^103] Brockbank was closely associated with Leavis
...
Leavis, albeit negatively.[^104] Janet Burroway, a contemporary of
...
slight, from which the subsequent reflection springs.[^107] By contrast,
...
means of focussing one’s attention but of diffusing it.’[^108] Prynne
...
> with a force not to be surpassed by anything but reality.[^109]
...
changed, bar\[red\] the poet from his most valuable material’.[^110] At
...
to use is no longer ‘shared’ in any real sense.[^111] Importantly,
...
dream-world.’[^112] Where Prynne describes meditative poetry as
...
predominates’.[^113] Leavis even identifies Tennyson as a key example of
the tendency: ‘He might wrestle solemnly with the “problems of the age,”
...
contemporary climate.’[^114]

Where ‘The Elegiac World’ diverges significantly from Leavis is in its
assessment of aesthetic developments subsequent to the nineteenth
...
relationship between late-Victorian and twentieth-century English poetry
...
by the word meditative.[^115] Eliot is considered in more detail at the
...
in question, and the emotional modality is largely neutralized.’[^116]
...
contemplates human life and asks what it all comes to.’[^117] Yet where
...
being the title of Prynne’s own first collection of poems.[^119]
...
‘perhaps alludes to Hardy’s *Satires of Circumstance*’.[^120] In the
...
substantially in doubt.[^122] Given this, it seems appropriate to read
the valorisation of ‘force of circumstance’ as an anti-Romantic,
...
and to record them.[^123] This certainly seems to be force of the phrase
...
brought the water to it’ in order to allow it to turn of its own
...
poet himself (pronoun Prynne’s). A contingent event is in this sense the
type of event most truly determined by circumstance. The final part of
Prynne’s comment—‘and least of all if he had been expecting it’—would
seem on this reading to be a joke at the expense of poets who are eager
to bear witness to contingent reality, but only within their own
pre-conceived formal structures.
...
during the ‘Two Cultures debate’ less than a decade earlier. Fuller
begins the lecture with two extended quotations. The first is taken from
...
discussion about the future of the English university system, it may be
taken as comparable to 1963. Prynne decries what he sees as the
government’s opportunistic use of the 2007–08 financial crisis as a
premise for cuts: ‘The current financial crisis is in historical terms a
local aberration; yet over-eager and reckless exploitation of the
justification it apparently offers, to ransack universities and override
their delicate autonomies, can surely inflict deep and permanent
damage.’[^177] He also appeals repeatedly to the University of
Cambridge’s leadership role in opposing government policy. There is a
strong sense here of the very same small-‘c’ conservatism that was
apparent in 1963. In phrases such as ‘delicate autonomies’ and ‘core
values’, Prynne slips into the sort of grandiloquent but ultimately
empty language that he himself parodied in 1969 with the phrase
...
the *status quo*: all change is bad change.[^178] If the analysis above
is correct, then Prynne’s relationship with Cambridge appears to be
broadly similar to Leavis’s. Leavis began as an outsider trying to get
in; he ultimately succeeded, but was never fully co-opted by the
institution. Prynne, on the other hand, began as a somewhat reluctant
insider. Though he later adopted a more oppositional stance which would
see him remain permanently eccentric to the real centres of academic
power, he has nevertheless maintained a basically conventional view of
the role of the university in society—in other words, as an autonomous
intellectual community bound by its own rules and traditions, which is
frequently in need of protection from bureaucratic state
intervention.[^179] Writing to Dorn in 1972, Prynne declares that
Cambridge ‘should never have’ given him a permanent job as he ‘won’t
ever produce the gavotte required’.[^180] While this is true if the
‘gavotte’ is taken to refer to the careful dance of professional
...
gained a certain level of academic influence.
...
refers to a 2004 document produced by Prynne for incoming students at
Caius, ‘Tips on Practical Criticism, for Students of English’. This
...
of reading and writing as forms of labor that produce value.’[^181] In
fact, ‘Prynne foregrounds the limitations that attend the
Arnold–Richards–Leavis emphasis on the preparatory nature of literary
study as moral training for citizenship.’[^182] Solomon’s reading is
...
centre.’[^202] Having followed this train of thought, however—‘if the
...
stepped into a wider & more open space’—his concluding question sounds a
note of hesitation: ‘what happens when this resistance—the necessity of
marginal status within the overall context—disappears from the scene
(Ph.D. theses and big publishers): will this operate as a liberation or
as a more desperate extremity?’ Though the grammar of this sentence
(‘when’, ‘will’) appears to present mainstream publication and academic
recognition as inevitabilities, the very fact that it is asked holds
open the prospect of continued resistance; and as the course of Prynne’s
own later career suggests, ‘Ph.D. theses’ do not always go hand-in-hand
...
*Prospect*, and ‘The Hazel Tree’, in *Tomorrow*.[^212] Both founded in
1959, *Prospect* and *Tomorrow* are in many ways mirror images of each
other, with the axis of reflection situated somewhere along the
...
Hamilton and Susil Pieris in Oxford.[^213] Both had reached their fourth
issue by the second half of 1960, each publishing a relatively broad
range of more or less established poets, though with almost no actual
overlap—aside from Prynne, the only contributor shared by the two
magazines is Harold Pinter. This may testify to the relative insularity
of the university communities which both *Tomorrow* and *Prospect*
represent, or at least the importance of personal contact in the
solicitation of work for publication, although both magazines also
...
German poet Arnfrid Astel, printed a single poem of Prynne’s,
‘Landfall’, a phenomenological consideration of a bridge which seems to
owe much to Martin Heidegger’s 1951 essay ‘Building Dwelling Thinking’
...
available.[^223] Prynne’s opening letters to the older poets, sent in
...
print some genuine kinetics now and then, if not more often.’[^224] He
...
foothold in prose theory.’[^225] In a short letter to Dorn the same
...
they don’t understand.’[^226] Instead, he presents a deliberately
...
different.’[^227] The reference to Cid Corman’s long-running magazine
...
letter suggests earlier contact.[^228] Having taken over *Prospect*, he
...
Atlantic.[^229] As he puts it in a subsequent letter to Corman, poets in
Britain need to ‘start again in ENGLISH, not your enviable US dialect,
which our natives *must* draw from but could never *use*.’[^230]
...
April of the same year.[^231] Writing to Dorn in July, he describes how
...
‘mainly through difficulties with funds’.[^232] At this point there is a
...
actually been distributed.[^233] What is most striking about this
...
I’m in contact with, and I am hopeful of what will follow.’[^234] To
...
in Q.D. Leavis’s consideration of Edith Wharton.[^237] What is most
...
across issues, but also as a sort of monument.[^238] It is in this
...
with alert zeal.’[^239] When Issue 6 finally emerged, its production
...
Ingrespapper.’[^240] Perhaps the most significant decision made by
...
the editor to ask for them.’[^241]
...
delivery.’[^242] There are a number of other factors which make the
...
subsequently be collected.[^243] *Prospect*, similarly, began with a
significant contribution from Olson—the poem ‘Maximus to Gloucester’—and
published his work again in Issues 4 and 6.[^244] Though not printed,
...
*milieu* surrounding the magazine.[^245]
...
immediately preceding *Prospect*’s launch.[^246] Seen in relation to
...
The preceding section set out the diverse range of little magazines with
which Prynne was involved in the very earliest stages of his literary
career. The present section will shift focus from the magazines
themselves to Prynne’s conception of the role of prose within them,
...
might gain a ‘foothold’ in its walls.[^247] If radical new American
...
writer’—both of which are equally corrupt and decrepit.[^248] Yet there
...
to it, in a broad array of forms including fiction, review and ‘poetic
theory’, with Prynne himself contributing one of the key pieces and
Davie—a figure who, as Chapter 1 showed, was certainly not immune from
charges of wiseacrey by this point—contributing another. The potential
explanations for this contradiction are twofold: either Prynne’s
...
early letters and the magazine’s eventual publication.[^249] The
...
printing the latter’s short story ‘The Grace’ as well.[^250] Equally, it
...
Jean Crozier and John James.[^251] As Latter notes, the worksheet had
...
the night of 6 December 1967.’[^252] By ‘Palace Revolution’, James is
referring to the removal of Riley from the editorship of the worksheet
by Prynne, Crozier and himself.[^253]
...
gestures’.[^254] It is clear that Prynne’s unhappiness with the issue
...
onwards from that base), is this all we have?’[^255] James’s collocation
...
which it is difficult to admire a person for having resisted.’[^256]
...
founded in 1965, had already achieved some notable successes in its
mission to curb population growth in the developing world.[^257] The
...
culture.[^258] A more immediate answer can, however, be found in one of
...
Times* reported was the longest sitting in more than 16 years.[^259] Its
...
recognisable political position.[^260] What, for example, does he mean
...
in agreement over the issue.[^261] ‘Genetic servo-mechanisms’ is even
...
smoke cloaks the octoberal, rusting garden’).[^264] As Chaloner’s
...
global financial markets.[^265] He explained this decision to Riley as
follows:
...
sandy desert of politics.’[^266] ‘\[M\]aybe we should take to the desert
...
prose: cannot it too be joined more freely into the world.’[^267] It is
...
the online journal and the easily shareable PDF file. The work was first
...
the worksheet’s first series.[^268] It was subsequently printed in
...
included in every edition of Prynne’s collected poems.[^269] ‘A Note on
...
piece.[^270] It is the first and last of these contexts with which this
...
more briefly.[^271] Without exception, these accounts use the text as
...
sculpture respectively. Blanton’s account of the piece is by far the
most detailed, situating it in a political tradition occupied
simultaneously by Ruskin and Marx. Nevertheless, this reading is offered
with the ultimate intention of making a point about poetic practice and
form, rather than of considering the text on its own terms, as prose.
Rather than cite a pre-existing summary of ‘A Note on Metal’ and risk
...
¶1 (p. 128[^272]): Before the early Bronze Age, property resided
...
concepts it discusses; it is patchy and meandering.’[^273] On the
...
Spinoza is the essential commencement of all Philosophy.’[^274] What
...
absolute unity is reality, it alone is God.’[^275] This dissolving of
...
in his approach.[^276] As Sutherland puts it, ventriloquising Prynne,
...
knowledge about our surroundings.[^278] This position leads to an
...
not in an ontological sense than at least in a cognitive one.[^279] At
...
work of the philosopher Quentin Meillassoux.
...
must be obvious.’ It is not immediately clear why they must.*
...
rather than by deliberate human effort.[^280] These discoveries do not,
...
*OED* definition 7[^281]). Even more confusing, however, is the phrase
...
the abstracting processes through which they are produced.[^282]
...
with spiritual content, help to determine future development.[^283]
...
labor input’ prior to mechanisation in the nineteenth century.[^284]
...
for the distribution of metalware, rooted in the Aegean market.’[^285]
...
Kraay which seems directly to contradict Prynne’s argument.[^286] As
...
just described developments in currency during the reign of Croesus,
Prynne’s use of the terms ‘middle class’ and ‘left-wing’ is apt to seem
highly anachronistic, even if their emergence is qualified as merely
‘possible’ (¶8)—this is, indeed, a central issue with ‘A Note on Metal’,
which will be discussed in more detail below. The most plausible
definition of ‘middle class’ in this context is a relatively strict
economic one: Prynne is obviously not referring, in the modern British
sense, to an organic combination of professionals and other white-collar
workers with elements of the labour aristocracy, but rather to a class
similar to that which Marx describes as manipulating ‘merchant’s
capital’ in historical eras prior to capitalism’s dominance of the mode
of production.[^288]
...
should journey as ‘honourable Beduins’.[^289] The real question, then,
...
consists precisely in the performance of this gesture.[^291] But is this
...
‘A Note on Metal’ is a member of this category.[^292] It is certainly
...
a similar status to the author’s note or the index of first lines.[^293]
...
into or challenge this history.[^296] ‘A Note on Metal’ is, quite
...
does mean.’[^297] Sutherland goes on to describe Prynne’s poem ‘Bronze :
...
scholarship.’[^298] His interpretation is supported by Prynne’s recent
...
rather early and rather freely.’[^299]
...
> purpose or general understanding of their place in the world.[^300]
...
perspective that constantly changes with my movements.’[^303] An object
of the imagination, by contrast, ‘is fixed, and lacks this openness to
further points of view.’[^304] Imaginative objects are ‘clear and
distinct’, while real objects are ‘resistant’.
...
difficulty when I encounter resistance.’[^305] In other words,
‘difficulty is cognitively prior to resistance but ontologically
dependent upon it.’[^306] Importantly, ‘resistance itself comes nearer
than any other differentiable quality to being completely inherent in
the object’.[^307] He then demonstrates the ‘viciousness’ of a position
like Wild’s, which ‘allows the external world only sufficient objective
...
> actions fully intelligible.[^308]
...
situation which would lead to a more familiar form of solipsism.
Meillassoux oscillates between these two perspectives, which are really
just a stronger and a weaker version of each other. Thus, in the short
paper ‘Time without Becoming’, he describes how ‘\[a\]ppeals to
intersubjectivity are of no account \[against the arche-fossil\], since
the time in question is \[…\] a time preceding all life, and so every
human community.’[^320] However, it is clear from the argument of *After
...
through which the correlationist might argue that
...
\noindent As Meillassoux rightly points out, ‘this rejoinder is a
...
difference between an arche-fossil from 13.5 billion years ago or one
from 1990, as long as it is anterior to the presently thinking
subject.[^322]
...
1967 which was discussed in Chapter 2. There, though he does not use the
word ‘polemic’, Prynne appeals explicitly to ‘*opinion*’ and ‘the
inter-modifying force of open *argument*’, advocating a rewriting of
Shelley which cannot be anything but polemical. Unless the opinions
...
seems reasonable to assume that Prynne is referring to the New York
School, particularly poets such as James Schuyler, Kenneth Koch and John
Ashbery, about whom he had already been thoroughly dismissive in a 1969
letter to Riley.[^353] This reading is confirmed by Prynne’s subsequent
exemption of Frank O’Hara, who, he claims, ‘had that pail of serpents
\[i.e. pain\] always in view.’ The *OED* gives the following definitions
for ‘nympholepsy’: ‘Passion supposedly inspired in men by nymphs; an
ecstasy or yearning, esp. that caused by desire for something
...
three-dimensional space). More interesting is the word ‘endocrine’,
which re-emphasises the bodily nature of the structure: different points
in the novel are linked to each other in an arrangement analogous to the
...
sex altogether eventually.’[^364] The one aspect of life in which ‘the
...
illusory.’[^365] Lewis uses a glancing reference to Henry Havelock Ellis
and the evidentially dubious assertion that ‘\[t\]he more clothes people
...
in his pages.’[^367] Importantly, Lewis connects the book implicitly
both to homosexuality and to immaturity by invoking the public school:
‘What is there is largely either freudian \[*sic*\] echoes (they had to
enter into it), or else it is horse-play of a schoolboy or public-house
order.’[^368] Like John Ashbery or his English followers, Joyce’s
...
her former Oxford colleague Stuart Hampshire.[^369] Central to this
...
the outer.’[^370] Applying this rule rigorously leads to a situation in
...
the things she would have said three years ago.’[^372] But, as Murdoch
...
occurred.[^373] Murdoch spends the remainder of the paper in an attempt
...
function of the progressive attempt to see the object clearly.’[^374]
...
no-harm like a clearing in the middle of harm.’[^376] Yet it can just as
...
along; you knew that. I love you.’[^377] In fact, it is not necessary to
...
position in British literary culture in the mid 1970s.[^380] Like
...
which includes *The Rotten Elements*, was printed.[^381] Shoring up this
...
Elements*.[^382] In the final volume, *No Home But the Struggle*, a
retired Sebrill reflects simultaneously on his childhood and on his
current involvement with the Campaign for Nuclear Disarmament. Towards
the end of the novel, he finally reaches a state of reconciliation
between poetry and politics, and the book ends self-referentially with
...
> \singlespacing \hspace{8pt} ‘How wrong the romantics were in their
> idea that for every person there exists somewhere a unique soul-mate.’
> \vspace{-16pt} \singlespacing \hspace{8pt} ‘Yes, and in practice it’s
> an idea that doesn’t go at all well with monogamy.’ \vspace{-16pt}
> \singlespacing \hspace{8pt} ‘Perhaps under full communism there will
> be a return to group marriage. Engels seems almost to favour that.’
> \vspace{-16pt} \singlespacing \hspace{8pt} ‘I suspect it rather
> appeals to you too.’ \vspace{-16pt} \singlespacing \hspace{8pt} ‘I
> confess I do have a sentimental hankering after it, because it would
...
> \vspace{-16pt} \singlespacing \hspace{8pt} ‘You always were a loyal
...
> drain on energy when there’s so much else to do.’[^384]

\noindent Divorced from its context, this passage risks taking on an
ironic tone which it does not necessarily possess in the original
narrative, where a line like ‘You always were a loyal feminist, dear’ is
actually representative of the way Upward’s characters speak. Taken at
face value, then, the message is one of seemingly justified scepticism
about the role of sexual experimentation in revolutionary practice—while
it may have its place in a communist future, Alan and Elsie seem to
agree, it is not properly part of the preparations for that future.
While desire is sensibly acknowledged in the form of Sebrill’s
‘sentimental hankering’, it is quickly repressed, not (supposedly) by
bourgeois sexual morality, but by reason: even the utopian description
of sexual relations under ‘full communism’ is conducted in logical
terms, its arrangement justified as a system of eminently sensible
‘compensations’. This acceptance of reproductive monogamy through a sort
of sexual pragmatism conforms almost exactly to Prynne’s concern for the
adult and mature, as opposed to the nympholeptic and pre-sexual, that
has already been described.[^385]
...
keeper’s compliments’.[^386] Written as far back as 1931, this story was
...
himself to a cause outside himself.’[^387] The publication history,
...
directly after the passage on Upward in his letter to Dorn.[^388]) Any
...
variously sinister and bizarre characters.[^389] ‘The Railway Accident’
...
extraordinary technique in other, more fruitful directions.’[^390] The
...
> with corrugated red wattles limped from holes among the rocks.[^391]
...
have to vie with that of the real world.[^393] Nevertheless, there is a
...
maintains a fixation on the Isle of Wight.[^394] More important,
...
much of the village’s uncanny atmosphere.[^395] The same can be said of
...
‘stumps of semi-amputated breasts’.[^396] Sex *per se* enjoys a liminal
...
but was expurgated prior to publication.[^397]
...
Upward.[^398] There are other works in Lewis’s *oeuvre* which track even
...
in 1927, though it was nearing its final form as early as 1919.[^399]
...
for Love* (1937), without providing further details.[^400] The themes
...
various ways in which his characters interact with their environment,
rarely from a conventional perspective of unilateral, authoritative
will. In the first of his explanatory pieces, ‘Inferior Religions’,
Lewis reverses conventional conceptions of human agency, describing his
...
rural Brittany and Spain).[^401] Apparently familiar human action is
...
great that it passes as open and untrammelled life.[^402] In the
...
> it is only familiarity that blunts it.’[^403]
...
mouth; 3. a dwarf genital face with a long nose.’[^404]
...
Border*\] I caught from Lewis.’[^405] If Oliver is excluded, however,
...
set out a basic theory of laughter. Lewis contends, in line with his
comments on ‘creaking men machines’, that ‘\[t\]he root of the Comic is
to be sought in the sensations resulting from the observations of a
*thing* behaving like a person.’[^406] As such, his characters are
‘puppets’: ‘I would present these puppets, then, as carefully selected
specimens of religious fanaticism. With their attendant objects or
fetishes they live and have a regular food and vitality. \[…\] Their
mechanism is a logical structure and they are nothing but that.’[^407]
One of the many definitions of laughter given by Lewis is as a
‘thunderbolt’ accompanying the fleeting recognition of oneself as just
such a puppet.[^408] The characters of Mortmere appear to conform to
Lewis’s model, their interactions determined by a ‘logical structure’
composed of diverse ‘objects and fetishes’. Upward’s and Isherwood’s
world is distinguished from Lewis’s by the tendency, as in a warped
detective story, of this logic to be simultaneously overt and
...
just below intuition, and life charged with black illusion.’[^410]
...
Oliver, as well as sharing a publisher with the latter two.[^411] Early
...
1972.[^412] The *PTM* is presented for the most part as an account of a
...
of Prynne’s work have so far been reluctant to do.[^413] This is not to
contradict Katko’s strongly argued claim that the science of the work
should be taken seriously, but it is to temper his subsequent contention
that ‘any projection of irony or satire onto the core propositions of
this treatise would be detrimental to a clear-eyed grasp of the
hypothesis’.[^414] While we might well agree that any such ‘projection’
...
Charles Darwin’s grandfather.[^415] Nevertheless, the decision to expand
...
undergraduate knockabout’.[^417] Crucially, the methods through which
...
of co-workers’ following ‘a prolonged lunch’.[^418] Cypress,
...
offence.[^419] Lichen embarks on a long and increasingly ill-tempered
...
taken in a good deal of liquid refreshment.’[^420] Of the texts
...
Cypress’; ‘Oh indeed yes, Professor Lichen’).[^421] The characters
...
underlying this London conference.’[^422]
...
spoonerisms uncorrected’.[^423] Nevertheless, intoxication is in both
...
imitates in the course of the lecture.[^424]
...
close to tenure if I want it’.[^425] As might be expected, this
...
combining academic work with childcare:
...
mid-to-late thirties emphasise maturity as an aesthetic criterion.
...
object as vehicle. Beyond defamiliarisation, the fundamental effect is
to remove the barrier between the body and its other: the body becomes a
simple part of the material world, just like anything else. At times,
however, this metaphorical structure breaks down into something less
rigid. This can be seen clearly in the second quotation from Oliver
...
been altered and its references have not been updated.’[^441] Here,
...
Time for loue of you | As he takes from you, I ingraft you new.’[^442]
...
English by default.[^443] There seems at first glance to be a ready-made
...
within the permitted and natural order of things.’[^446] Through a
consideration of the gradual accretion of pejorative connotations around
the word ‘conceit’, however, Prynne reveals the complex and multiple
layers of artificiality which make up such tropes: ‘grafting was
recognised as a curious, subtle and conceited action \[…\]; in
figurative contexts this element of conceitfulness is compounded, since
the trope is itself a product of inventive conceit and (by extension) is
itself termed “a conceit.”’[^447] The end result of this spiral of
artificiality is to reveal how the system extends in both directions: if
the use of grafting as a way to describe artificiality is a conceit,
then the bias towards nature is itself artificial, if not in its origin
then certainly in its persistence. The maintenance of a distinction
between nature and artifice—a precondition of the privileging of
nature—is dependent on rhetorical and metaphorical techniques which are
just as constructed as those used in an argument such as Polixenes’s.
...
‘art-gallery nympholepts’ has already been considered; the
...
‘mathematico-physico-chemical morphology’.[^452]
...
Waddington.’[^453] Interest in the Gathering’s activities from the
Rockefeller Foundation very nearly led to the endowment of a dedicated
institute at Cambridge, but the reigning scientific authorities’
personal and political antipathy towards Needham, as well as the group’s
threat to established disciplinary boundaries, saw the project
axed.[^454] Nevertheless, as Abir-Am convincingly argues, the group’s
research programme helped make possible ‘the currently dominant
DNA-centred conception of molecular biology \[…\]. Indeed “molecular
...
collective discourse’.[^455] There can be few clearer representatives of
this ‘currently dominant \[…\] conception’ than Needham and Prynne’s
colleague at Caius, Francis Crick, who in 1953 was jointly responsible
for the discovery of the structure of DNA itself.[^456] Writing to Dorn
in 1978, Prynne describes a dinner with Crick and Needham, noting that
‘\[t\]here was a touch of electric collusion in the air, since the
former should (& could) have succeeded the latter’; it is unclear
whether he is referring to general intellectual succession or to
something more prosaic such as the mastership of Caius, which had fallen
from Needham to the lawyer William Wade two years earlier.[^457] In any
...
theory known as ‘directed panspermia’.[^459] Crick later elaborated this
theory in a monograph, *Life Itself: Its Origin and Nature* (1981), the
UK publication of which prompted a letter from Prynne. Here, Prynne
offers an extension to the hypothesis, speculating about the potential
motives of an alien civilisation which, to have reached the stage of
fertilising other planets, is ‘likely to have persisted in the
development and satisfaction of an intense intellectual
curiosity.’[^460] He points out that ‘\[t\]he far-sighted would think
out the predicaments produced by instances of success \[…\]
recognis\[ing\] that, in a successfully evolved colony, the question
would inevitably arise there about their own origins.’ Prynne’s
following questions are worth quoting at length:
...
taste, that nature of her selfe woulde neuer haue done.’[^461] He
...
which the real-life Erasmus Darwin enthusiastically subscribed.[^462]
...
Building*, a body which is identified partly with that of his son.[^463]
...
scrupulously signed and dated.[^464] The link to Prynne’s implicit
...
it is fairly clear that Prynne’s pro-procreative attitude there, and his
...
panspermia.[^465] The same can be said of his attitude to metaphor,
...
growth’—is a key feature of the *PTM*’s biochemical hinterland.[^466] In
...
\noindent Prynne admits that ‘these thoughts do nothing to resolve the
fundamental uncertainty’, and even that ‘to look for a message must, I
suppose, inevitably increase the possibility of deluding oneself that a
message has been found’. Crucially, however, he does not therefore
abandon the search, concluding the letter with a re-affirmation that
‘the question of a message built into the fundamental structure does
strike me as one for which a small niche might be found; even if its
position there were merely that of an ornament, or an irritant, or
both.’ This structure—the growth of a pearl of logic around a minute
grain of its ‘irritant’ opposite (hope, free choice, the deliberate
suspension of accuracy)—is absolutely characteristic of Prynne’s
thought, corresponding, for example, to the declaration of uncertainty
which concludes ‘A Note on Metal’ or the act of instantiation which
makes a new poem part of the world. In a version of Pascal’s wager in
which the prize is not heavenly but immanent, Prynne implicitly exhorts
us to copy the behaviour of a good scientist who we have no proof ever
...
ethics. In fact, of course, this is all we are—but it is the refusal to
accept this condition which allows us finally to live in it. Writing to
Dorn about Crick’s *Life Itself*, Prynne quotes the author’s contention
that ‘chance is the only source of true novelty’, ‘chance’ being Crick’s
particular irritant grain. ‘I tell that to the tip of my pencil, every
day’, continues Prynne, ‘and it fills in the missing step: “chance is
the main source of true boredom and only that is the source of
novelty.”’[^467] \newpage
...
pursuit’.[^469] Introducing the recent *Cambridge Introduction to
...
marbled by its context.’[^470] Falci’s simultaneous disavowal both of
...
understand everything!’[^471] Yet in his own published and unpublished
work he makes extensive use of biographical material—not as ‘colour’ for
the main analysis, but as a fundamental tool, showing *how* history gets
where it does. Prynne’s notes for undergraduates on Ezra Pound, for
example, begin with a three-page biographical chronology, complete with
two separate references for further material about Pound’s life.[^472]
In the case of George Herbert, he goes so far as to lament the lack of
available biographical information, particularly about Herbert’s library
and reading habits.[^473]

Any biographically minded approach to Prynne must, nevertheless, contend
with the his published comments on the irrelevance of such criticism to
his own work. This attitude is expressed explicitly in a prose piece
from late 2015, a transcription of ‘a faxed memorandum sent to
\[Joshua\] Kotin and \[Jeff\] Dolven, who recently interviewed the
author for a forthcoming issue of *The Paris Review*.’[^474] Here,
...
> work will open up many kinds of interiority, yours and mine.[^475]
...
record of the writing life.’[^476] It is Prynne’s first substantial
...
unpublished’.[^477]) Near the beginning of the essay, for example,
...
under the floorboards’.[^478] Later, he describes visiting huts in
...
time on anecdotes than on the poems themselves.[^479]
...
> T.S., W.B., E.M., D.H., L.P., W.H. and so on.[^480]
...
R.F. Langley.[^481] In Prynne’s case, that tradition might owe as much
...
male-dominated.[^482] Even so, its contention has been that Prynne’s
...
Modernist Poetics*.[^483] Andrea Brady is right to point out that such
models risk becoming ‘fantasies of all-male reproduction’, particularly
when extended into the present.[^484] Yet, in what is perhaps itself a
...
the figure of the father, using the word itself four times.[^485] In
...
double back in the poem’s third act: ‘Love him’ (84).[^486] The
...
interrupt’.[^488] Thus, in the poem’s final stages, an overbearingly
...
boots | on the lawn’.[^489] The pseudo-Victorianism of this passage—its
...
work.[^490] What, then, is the structure of this ‘haunting’, and what
...
the child in the womb’.[^491] Pound is, however, much more ready than
Prynne to acknowledge direct poetic influence.[^492] The most famous
...
pig-headed father; | I am old enough now to make friends.’[^493] Pound
presents his task as one of refinement: ‘It was you that broke the new
wood, | Now is a time for carving.’[^494] Prynne’s *oeuvre* contains no
...
successively shrinking sub-fathers.[^495] The apparent genealogical
...
structurally impossible in the analysis itself. In the present case, the
fact that a particularly patrilineal, Poundian air emerges from a
consideration of Prynne’s early career has the potential to shed further
light on the periodisation of his work. Would the selection of a period
other than 1955–75 for contextual analysis—say, the period from the
publication of *Poems* in 1982 to Prynne’s retirement from academic life
in 2005—have necessitated a different structuring force? What is
obscured by the structure that has emerged? The type of poetic
inheritance which it is possible to extrapolate from the good scientist
trope is, for one thing, entirely androcentric.[^496] Descent is based
structurally on the male side of the reproductive process, with almost
no regard for the female.[^497] Any conception of poetic creation based
even metaphorically on a ‘natural’ view of sexual reproduction is also
...
idealised figure is more or less implicitly a heterosexual man.[^498]
...
by other means then the diagram might be used to trace its probable
contours.[^500]
...
> incarnations, in cherishment and in trust.[^502]
...
intrinsically hard to recognize accurately’.[^503] Part of this
...
The poetical is personal and the personal is political: ‘the authorial
position is not reserved from any of the moral damage’.[^504] As long as
...
Dowden’s Letters to English Poets)’, in *Certain Prose of the English
Intelligencer*, ed. by Neil Pattison, Reitha Pattison and Luke Roberts
(Cambridge: Mountain Press, 2012), 2:\[‘Ghost Issue’\] \[G3\], 168–69
(p. 168)

‘The Art of Poetry No. 101’, interviewed by Jeff Dolven and Joshua
Kotin, *The Paris Review*, 218 (Fall 2016), pp. 174–207

‘The Bee Target on his Shoulder’, in *Poems*, 3rd edn (Tarset: Bloodaxe,
2015), pp. 150–52

*Chansons à la Journée-Lumière*, trans. by Bernard Dubourg (Damazan:
...
&lt;http:\slash \slash www.admin.cam.ac.uk\slash reporter\slash 2010–11\slash weekly\slash 6211\slash section13.shtml&gt;
...
*Lézard de Feu*, trans. by Bernard Dubourg (Damazan: privately printed,
1975)
...
‘Full Tilt Botany: Ideal Weapon for Suicide Pacts’, *Bean News* (1972),
\[p. 8\]
...
*Poèmes de Cuisine*, trans. by Bernard Dubourg (Damazan: privately
printed, 1975)

Reading (York Street Commune, Vancouver, 1 August 1971), *Archive of the
Now*
&lt;http:\slash \slash www.archiveofthenow.org\slash authors\slash ?i=77&f=1762\#1762&gt;
...
&lt;http:\slash \slash babylon.acad.cai.cam.ac.uk\slash students\slash study\slash english\slash pound\slash pound0.pdf&gt;
...
‘Tips on Practical Criticism, for Students of English’, *Gonville and
Caius College*,
&lt;http:\slash \slash babylon.acad.cai.cam.ac.uk\slash students\slash study\slash english\slash tips\slash praccrit.pdf&gt;
\[accessed 26 September 2016\]

‘Tips on Reading, for Students of English’, *Gonville and Caius
College*,
&lt;http:\slash \slash babylon.acad.cai.cam.ac.uk\slash students\slash study\slash english\slash tips\slash reading.pdf&gt;
...
\setlength{\parindent}{0pt} \setlength{\leftskip}{0pt}

General
-------

\setlength{\parindent}{-16pt} \setlength{\leftskip}{16pt}
\hspace{-16pt}Abir-Am, Pnina G., ‘The Biotheoretical Gathering,
Transdisciplinary Authority and the Incipient Legitimation of Molecular
Biology in the 1930s: New Perspective on the Historical Sociology of
Science’, *History of Science*, 25 (1987), pp. 1–70
...
&lt;http:\slash \slash www.oed.com\slash view\slash Entry\slash 7367&gt;
\[accessed 29 June 2016\]

Arblaster, Anthony, ‘Edward Upward and the Novel of Politics’ (1978),
*Edward Upward*,
&lt;http:\slash \slash www.edwardupward.info\slash pdfs\slash Arblaster.pdf&gt;
\[accessed 5 May 2015\]
...
J. H. Prynne’s *Kazoo Dreamboats*’, *Chicago Review*, 57.3\slash 4
(Winter 2013), pp. 54–70

Brinton, Ian, ed., *For the Future: Poems and Essays in Honour of J.H.
Prynne on his 80th Birthday* (Bristol: Shearsman, 2016)

—, ed., *A Manner of Utterance: The Poetry of J.H. Prynne* (Bristol:
Shearsman, 2009)

—, ‘Prynne in Prospect’, *academia.edu*,
&lt;https:\slash \slash www.academia.edu\slash 6185230\slash Prynne\_in\_Prospect&gt;
...
1880–1955* (Oxford: Oxford University Press, 2009)

— and Andrew Thacker, eds, *The Oxford Critical and Cultural History of
Modernist Magazines, Volume II: North America 1894–1960* (Oxford: Oxford
...
&lt;http:\slash \slash snarkmarket.com\slash blog\slash snarkives\slash selfdisclosure\slash paper\_modernism\slash &gt;
\[accessed 29 January 2015\]

‘Certain Matters’, in *Certain Prose*, 2:\[‘Ghost Issue’\] \[G16–17\],
pp. 173–75
...
&lt;http:\slash \slash jacketmagazine.com\slash 24\slash clark-s.html&gt;
...
Moore, 1796),
&lt;https:\slash \slash archive.org\slash details\slash botanicgardenpoe02darwuoft&gt;
...
—, *The Heyday of Sir Walter Scott* (London: Routledge & Kegan Paul,
1961)
...
1963),
&lt;http:\slash \slash drc.libraries.uc.edu\slash bitstream\slash handle\slash 2374.UC\slash 696768\slash Elliston\_Donald\_Davie\_03–29–63\_A\_Track\_07.mp3?sequence=15&gt;
...
—, *A Winter Talent and Other Poems* (London: Routledge & Kegan Paul,
1957)
...
—, *The Rites of Passage: A Brief History* (Buffalo, NY: Frontier Press,
1965)
...
Falci, Eric, *The Cambridge Introduction to British Poetry, 1945–2010*
...
*Textual Practice*,
&lt;http:\slash \slash www.tandfonline.com\slash doi\slash full\slash 10.1080\slash 0950236X.2016.1188143&gt;
...
&lt;https:\slash \slash doctorzamalek2.wordpress.com\slash 2014\slash 03\slash 06\slash meillassouxs-archefossil-is-not-an-argument\slash &gt;
\[accessed 12 June 2015\]

Hawking, Stephen, *The Large Scale Structure of Space-Time* (Cambridge:
...
Humphreys, K.W., R.O. MacKenna and M. Tyson, letter, *The Times* (2
August 1963), p. 13
...
&lt;http:\slash \slash www.poetryfoundation.org\slash bio\slash jh-prynne&gt;
\[accessed 15 December 2014\]

‘J. H. Prynne’, *Wikipedia, The Free Encyclopedia*, 3 July 2014, 07:56
UTC,
&lt;http:\slash \slash en.wikipedia.org\slash w\slash index.php?title=J.\_H.\_Prynne&oldid=615398780&gt;
\[accessed 15 December 2014\]

Johansson, Birgitta, *The Engineering of Being: An Ontological Approach
to J.H. Prynne* (Umeå: Acta Universitatis Umensis, 1997)
...
&lt;http:\slash \slash www.pnreview.co.uk\slash cgi-bin\slash scribe?item\_id=35&gt;
...
Klein, Scott W., ‘Introduction’, in Wyndham Lewis, *Tarr* (Oxford:
Oxford University Press, 2010), pp. ix–xxix
...
&lt;http:\slash \slash intercapillaryspace.blogspot.co.uk\slash 2010\slash 04\slash scheming-for-possible-world-j.html&gt;
...
Marx, Karl, *Capital*, vol. 3, ed. by Friedrich Engels, in
*Marx\slash Engels Collected Works*, vol. 37 (New York: International
Publishers, 1998)
...
—, ‘Time without Becoming’ (8 May 2008),
&lt;https:\slash \slash speculativeheresy.files.wordpress.com\slash 2008\slash 07\slash 3729-time\_without\_becoming.pdf&gt;
\[accessed 12 June 2015\]
...
Miller, David and Richard Price, *British Poetry Magazines, 1914–2000*
...
&lt;http:\slash \slash www.modernistmagazines.com\slash &gt; \[accessed
15 January 2015\]
...
&lt;http:\slash \slash www.oed.com\slash view\slash Entry\slash 122712&gt;
...
&lt;http:\slash \slash theclaudiusapp.com\slash 4-nealon.html&gt;
\[accessed 10 October 2013\]
...
&lt;http:\slash \slash www.oed.com\slash view\slash Entry\slash 129422&gt;
...
—, *Letters for Origin, 1950–1956*, ed. by Albert Glover (London: Cape
Goliard 1969)
...
—, *The Special View of History*, ed. by Ann Charters (Berkeley, CA:
Oyez, 1970)
...
&lt;http:\slash \slash archiveshub.ac.uk\slash data\slash gb2188-dsh04&gt;
...
&lt;http:\slash \slash www.oxforddnb.com\slash view\slash article\slash 60078&gt;
...
Press, 2009),
&lt;http:\slash \slash www.oxfordreference.com\slash view\slash 10.1093\slash acref\slash 9780192806871.001.0001\slash acref-9780192806871-e-9225&gt;
\[accessed 15 December 2014\]
...
1945–1975*, ed. by Rebecca Peabody (Los Angeles, CA: Getty Publications,
2011), pp. 133–47
...
&lt;https:\slash \slash www.gov.uk\slash government\slash uploads\slash system\slash uploads\slash attachment\_data\slash file\slash 31999\slash 10–1208-securing-sustainable-higher-education-browne-report.pdf&gt;
\[accessed 3 March 2014\]
...
Stansky, Peter, *Edward Upward: Art and Life* (London: Enitharmon Press,
2016)

Steele, Laura, ‘Comedy and the Conceptual in Douglas Oliver’s *The
Harmless Building*’, *Intercapillary Space* (September 2006),
&lt;http:\slash \slash intercapillaryspace.blogspot.co.uk\slash 2006\slash 09\slash comedy-and-conceptual-in- douglas.html&gt;
...
&lt;http:\slash \slash www.theparisreview.org\slash interviews\slash 1033\slash the-art-of-poetry-no-78-charles-tomlinson&gt;
...
*Edward Upward*,
&lt;http:\slash \slash www.edwardupward.info\slash pdfs\slash No\_Home\_But\_the\_Struggle.pdf&gt;
\[accessed 5 May 2015\]

—, ‘The Railway Accident’, in Upward, *The Railway Accident and Other
Stories* (London: Penguin, 1972), pp. 33–84

—, *The Rotten Elements*, ed. by David Allinson, *Edward Upward*,
&lt;http:\slash \slash www.edwardupward.info\slash pdfs\slash The\_Rotten\_Elements.pdf&gt;
\[accessed 27 November 2015\]

—, ‘Statement for the Literature\slash Sociology Conference on “1936” at
Essex University, July 1978’, *Edward Upward*,
&lt;http:\slash \slash www.edwardupward.info\slash pdfs\slash Statement.pdf&gt;
\[accessed 5 May 2015\]

—, *In the Thirties*, ed. by David Allinson, *Edward Upward*,
&lt;http:\slash \slash www.edwardupward.info\slash pdfs\slash In\_the\_Thirties.pdf&gt;
\[accessed 26 September 2016\]

‘Watercolour’, *Tate*,
&lt;http:\slash \slash www.tate.org.uk\slash whats-on\slash tate-britain\slash exhibition\slash watercolour&gt;
...
&lt;http:\slash \slash www.oxfordreference.com\slash view\slash 10.1093\slash acref\slash 9780199640256.001.0001\slash acref-9780199640256-e-1383&gt;
\[accessed 15 December 2014\]
...
[^5]: Following the model of the fourth chapter of Sutherland’s ‘J.H.
    ...
    *Acrylic Tips* (2002) to the work of John Kinsella (Hall,
    pp. 130–32)—is less concerned with the local history of the work’s
    production. Ryan Dobran’s thesis makes full use of both modes, but
    is less straightforwardly historical than Latter’s work, being
    organised around the concept of difficulty.
...
[^18]: Prynne, ‘Stille (nach Thomas Hood)’, *Six* (1955), p. 11.
...
[^20]: Mellors, *Late Modernist Poetics: From Pound to Prynne*
    (Manchester: Manchester University Press, 2005), p. 2.

[^21]: *Poèmes de Cuisine* (Damazan: privately printed, 1975); *Chansons
    à la Journée-Lumière* (Damazan: privately printed, 1975); *Lézard de
    Feu* (Damazan: privately printed, 1975).
...
[^26]: Prynne, *Poems*, 3rd edn (Tarset: Bloodaxe, 2015).
...
[^28]: Sutherland, ‘J.H. Prynne and Philology’, p. 238.
...
[^29]: Arguing against Anthony Mellors, Sutherland takes a version of
    ...
    over the precise character of the break (Sutherland, ‘J.H. Prynne
    and Philology’, p. 175, n. 329). Davie, for his part, seems to
    locate a break somewhere within the pages of *Brass*; having written
    confidently about much of *The White Stones*, he claims in 1973 that
    ‘The Ideal Star-Fighter’ is ‘the only one of \[Prynne’s\] recent
    poems which I think I understand’ (Donald Davie, *Thomas Hardy and
    British Poetry* \[London: Routledge & Kegan Paul, 1973\],
    pp. 177–78).
...
[^32]: Prynne, ‘A Dialogue with Nicholas Royle’.
...
[^36]: Alex Latter, ‘“Essential news”: a history of *The English
    ...
    Mengham (email to the author, 2 February 2014).
...
[^39]: Davie, *Articulate Energy*, p. ix. In fairness, Davie is
    ...
    one after the other, and to read my poems too’ (*ibid*.). His later
    sympathies with the modernist project are well-known.
...
[^45]: Davie, ‘A Reading of His Poems’ (reading, University of
...
[^46]: Davie, *The Poems of Doctor Zhivago* (Manchester: Manchester
    University Press, 1965).

[^47]: Davie, ‘A Reading of His Poems’.

[^48]: Davie, ‘NOVEMBER 14th, 1958’.

[^49]: Prynne to Cid Corman, 19 November 1961. It is worth noting that
...
[^50]: Prynne, ‘from a letter’, *Mica*, 5 (Winter 1962), 2–3, 28 (p. 3).
    ‘Muscle’ is not always a negative term, however—writing to Dorn
    having just composed ‘The Wound, Day and Night’, Prynne claims that
    ‘I begin to feel like a muscle-man, and the relief of *for the first
    time* some confidence in the profession’ (Prynne to Dorn, 26 January
    1966). In another letter to Dorn from 1964, he writes admiringly of
    the ‘muscular ease’ of the Australian novelist Patrick White’s prose
    (Prynne to Dorn, 21 December 1964).

[^51]: Davie, *Collected Poems, 1950–1970* (London: Routledge & Kegan
    Paul, 1972), p. 303.

[^52]: Davie, ‘A Letter to Curtis Bradford’, in *Collected Poems*
    (1990), 98–99 (p. 99).

[^53]: Davie, ‘For Doreen. A Voice from the Garden’, in *ibid*.,
    pp. 99–100 (p. 100).

[^54]: Whatever his antipathy towards the sequence in 1961, Prynne did
    at least send a copy to Dorn, suggesting a certain level of interest
    (Dorn to Olson, 3 March 1965).

[^55]: Prynne to Ed Dorn, 29 April 1962. In an interesting slip, Prynne
    refers to *The Newly Fallen* as ‘*For the Unfallen*’, the title of a
    1959 collection by Geoffrey Hill.

[^56]: ‘Elections to Fellowships’, *The Caian* (Lent 1963), p. 33.
    Latter, *Late Modernism and ‘The English Intelligencer’* (London:
    Bloomsbury, 2015), p. 239, n. 4.

[^57]: Davie, ‘Remembering the Movement’, p. 74.

[^58]: Prynne to Dorn, 9 July 1962.

[^59]: Davie, ‘Remembering the Movement’, p. 72.

[^60]: Prynne, ‘A Gold Ring Called Reluctance’, in *Poems*, 21–23
    (p. 22).

[^61]: *Ibid*., p. 23; John Press, *Rule and Energy: Trends in British
...
[^62]: Prynne to Olson, 7 November 1962.

[^63]: Prynne to Dorn, 31 December 1962.

[^64]: Prynne to Dorn, 10 December 1962.

[^65]: Kingsley Amis, quoted in Zachary Leader, *The Life of Kingsley
    Amis* (London: Random House, 2013), p. 284.

[^66]: Prynne to Dorn, 14 April 1963.

[^67]: Davie, ‘Spender Struggling’, *The New Statesman*, 65 (29 March
    1963), p. 465.

[^68]: Prynne to Dorn, 10 December 1962.

[^69]: Prynne to Olson, 24 April 1963; Prynne to Dorn, 17 June 1965.

[^70]: Prynne to Peter Riley, 9 August 1967.

[^71]: Prynne to Riley, 7 February 1968.

[^72]: Charles Tomlinson, ‘The Art of Poetry No. 78’, interviewed by
...
[^73]: ‘The Literary Society’, *Fifty-Fifth Annual Report* (Cambridge:
    Jesus College Society, 1959), 60–61 (p. 61).

[^74]: Tomlinson, ‘The Middlebrow Muse’, p. 208.
...
[^78]: As Prynne puts it in a recent interview, ‘Davie wanted very much
...
[^79]: Donald Davie and D.J. Enright, ‘*New Lines* and Mr. Tomlinson’,
    *Essays in Criticism*, 7.2 (April 1957), 343–45 (pp. 343–44).

[^80]: *Ibid*., p. 345.

[^81]: Martin Dodsworth, ‘The Movement: Never and Always’, in *The
    Oxford Handbook of Contemporary British and Irish Poetry*, ed. by
    Peter Robinson (Oxford: Oxford University Press, 2013), 94–110
    (p. 103).

[^82]: Marriott, p. 81, n. 8.

[^83]: Prynne to Dorn, 31 December 1962.

[^84]: Schedule, *Radio Times* (13 December 1962), p. 13.

[^85]: Schedule, *Radio Times* (6 December 1962), p. 49. It would,
    however, be misleading to characterise the Programme’s output as
    entirely academic; for a detailed account of the BBC’s dealings with
    contemporary poets through the Third Programme, concentrating
    primarily on the 1940s and ’50s, see Kate Whitehead, *The Third
    Programme: A Literary History* (Oxford: Oxford University Press,
    1989).

[^86]: David Daiches, another of Prynne’s potential supervisors at
    Jesus, was also a regular feature on the Third Programme throughout
    the 1950s and ’60s.

[^87]: Peter Orr, ed., *The Poet Speaks: Interviews with Contemporary
    Poets* (London: Routledge & Kegan Paul, 1966). Prynne’s interview
    was not included in this book.

[^88]: Prynne interviewed by Orr, *The Poet Speaks*, Programme 39 (6
    January 1964).

[^89]: Prynne, ‘“Modernism” in German Poetry’, *The Cambridge Review* (9
    March 1963), 331–33, 335, 337 (p. 337).

[^90]: Prynne, ‘from a letter’, p. 3; Prynne to Olson, 4 November 1961.
...
[^91]: Prynne to Olson, 9 September 1962.

[^92]: Tomlinson, ‘The Art of Poetry’. Prynne himself notes, in a letter
...
[^93]: Zachary Leader, ‘Introduction: Origins and Ambivalences’, in *The
    Movement Reconsidered: Essays on Larkin, Amis, Gunn, Davie and Their
    Contemporaries* (Oxford: Oxford University Press, 2009), 1–15
    (p. 8).

[^94]: David Trotter, *The Making of the Reader: Language and
    Subjectivity in Modern American, English and Irish Poetry* (London:
    Macmillan, 1984), p. 221.

[^95]: In this respect, Prynne followed Leavis’s strictures against the
    ‘literary racket’ much more closely than any of the poets of the
    Movement, who nevertheless looked to ‘the great doctor’ as a key
    influence (Blake Morrison, *The Movement: English Poetry and Fiction
    of the 1950s* \[Oxford: Oxford University Press, 1980\], pp. 63–64).

[^96]: Prynne and Sutherland, ‘Introduction to Prynne’s Poems in
...
[^97]: Prynne did in fact begin a doctoral thesis on the work of Thomas
    Hardy, but only completed one year of research before his election
    (Johansson, p. 67, n. 66).

[^98]: Andrea Brady, letter, *Cambridge Literary Review*, 1.2 (Lent
    2010), 244–49 (p. 244).

[^99]: Nigel Wheale, ‘Cambridge School, The’, in *The Oxford Companion
...
[^100]: Christopher Hilliard, *English as a Vocation: The ‘Scrutiny’
...
[^101]: David Matthews, *Memories of F.R. Leavis* (Bishopstone: Edgeways
    Books, 2010), p. 4.

[^102]: Prynne and Sutherland, p. 201.

[^103]: ‘Papers Relating to “Players of Shakespeare”’, *Archives Hub*,
...
[^104]: *Fifty-Fifth Annual Report* (Cambridge: Jesus College Cambridge
    Society, 1959), p. 44.

[^105]: Janet Burroway, ‘Was Too: Time Passed with David Daiches’, in
...
[^106]: Prynne, ‘The Art of Poetry’, p. 186; Raymond Williams, ‘Our Debt
...
[^110]: F.R. Leavis, *New Bearings in English Poetry: A Study of the
    Contemporary Situation* (London: Chatto & Windus, 1932), p. 12.

[^111]: Prynne, ‘The Elegiac World’, p. 290. Similar points are often
...
[^115]: Prynne, ‘The Elegiac World’, p. 290.

[^116]: *Ibid*., p. 291. Prynne’s position *vis-à-vis* Eliot is made
    ...
    experience’ rather than ‘the poem’s achieved shape’ (Prynne, ‘from a
    letter’, p. 28).

[^117]: Leavis, *New Bearings*, p. 83.

[^118]: Prynne, ‘The Elegiac World’, p. 291. The sense of Eliot as
...
[^120]: Clark, ‘Prynne and the Movement’.

[^121]: James Keery, ‘The Great Tradition’, *PN Review*, 23.6 (1997),
...
[^172]: ‘The Library’s Place’, *Times Literary Supplement* (9 August
    ...
    *The Times* \[2 August 1963\], p. 13), and by a response from the
    head librarian at the Bodleian, J.N.L. Myres, which was highly
...
[^200]: Mellors, *Late Modernist Poetics*, p. 119.
...
[^203]: Poems that have never been printed as standalone books or
    pamphlets have been excluded, along with the periodicals in which
...
[^206]: The most comprehensive account of the *Intelligencer* is
    ...
    by Pattison, Reitha Pattison and Luke Roberts (Cambridge: Mountain
...
[^207]: Susan Brown, email to the author, 9 October 2013. Some sense of
    ...
    *London Review of Books*, 24.2 (14 January 2002), pp. 3–14.
...
[^211]: Prynne, ‘Stille (nach Thomas Hood)’. The poem is credited to
    ‘J.H.’ rather than ‘Jeremy’ Prynne, following a consistent form for
    all contributors, and perhaps representing the origin of the
    initialisation that Prynne would adopt for almost all of his
    subsequent poetic work.
...
[^215]: Prynne, ‘Landfall’, *Lyrische Hefte*, 10 (November 1961), p. 19.
    ...
    seems likely that Prynne would have encountered it in German. In
...
[^216]: Prynne, ‘Damp’, *Mica*, 2 (February 1961), p. 22; Prynne,
    ‘Perspective from a Chalk Pit’, *ibid*., p. 23; Prynne, ‘Surface
    Measures’, *Mica*, 4 (Fall 1961), p. 30; Prynne, ‘Until Later On’,
    *ibid*., p. 31; Prynne, ‘from a letter’.

[^217]: Prynne, ‘Early Yesterday Morning’, *Satis*, 5 (Spring–Summer
    1962), p. 14; Prynne, ‘In Praise’, *ibid*., pp. 14–15.
...
[^221]: Prynne to Riley, 25 February 1969. The Olson review was
    eventually printed as Prynne, ‘Charles Olson, Maximus Poems IV, V,
    VI’, *The Park*, 4.5 (Summer 1969), pp. 64–66, while the Creeley
    review can be found in Box 19, Folder 327 of Ed Dorn’s papers.

[^222]: Prynne to Riley, 16 February 1969.

[^223]: Ian Brinton, ‘Prynne in Prospect’, *academia.edu*,
    &lt;https://www.academia.edu/6185230/Prynne\_in\_Prospect&gt;
    \[accessed 21 January 2015\].

[^224]: Prynne to Olson, 4 November 1961.

[^225]: Prynne to Olson, 26 November 1961.

[^226]: Prynne to Dorn, 29 November 1961. In his initial letter to Dorn,
    Prynne notes that *Prospect* is ‘not out to shock like Tom Raworth’s
    OUTBURST’ (Prynne to Dorn, 16 November 1961).

[^227]: Prynne to Dorn, 29 November 1961.

[^228]: Prynne refers to Corman by his Christian name, whereas in his
...
[^229]: Prynne to Corman, 18 October 1961.

[^230]: Prynne to Corman, 19 November 1961.

[^231]: Prynne to Olson, 14 February 1962.

[^232]: Prynne to Dorn, 9 July 1962; Prynne to Dorn, 26 September 1962.

[^233]: Prynne to Olson, 1 February 1964; Prynne to Dorn, 30 June 1964.

[^234]: Prynne to Olson, 29 February 1964.

[^235]: Prynne to Dorn, 30 June 1964.

[^236]: Prynne to Robert Creeley, 21 October 1964.

[^237]: Q.D. Leavis, ‘Henry James’s Heiress: The Importance of Edith
    Wharton’, in *A Selection from ‘Scrutiny’*, vol. 2, pp. 124–36.

[^238]: Writing to Peter Riley about the *Intelligencer* several years
...
[^239]: Prynne to Olson, 6 March 1964. While it is not entirely clear
...
[^240]: Production note, *Prospect*, 6 (Spring 1964), \[p. 45\].

[^241]: *Ibid*. Setting aside trivial examples such as the 1998 *Mays*
...
[^242]: Prynne reveals his intention to transform the distribution of
    *Prospect* as early as his first letter to Olson: ‘I would rather
    ...
    Review* interview, in which Prynne notes explicitly that it was
    ‘never circulated at cost. It was sent to selected recipients who
    were serious about the content’ (Prynne, ‘The Art of Poetry’,
    p. 181).

[^243]: Charles Olson, *Letters for Origin, 1950–1956*, ed. by Albert
    Glover (London: Cape Goliard, 1969).

[^244]: Olson, ‘Maximus to Gloucester’, *Prospect*, 1 (Summer 1959),
...
[^245]: Olson, ‘Letter to Elaine Feinstein’, in *Collected Prose*, ed.
...
[^246]: Tim Carmody, ‘Paper Modernism’, *Snarkmarket* (9 August 2009),
    &lt;http://snarkmarket.com\slash blog\slash snarkives\slash selfdisclosure\slash paper\_modernism/&gt;
    \[accessed 29 January 2015\].

[^247]: Prynne to Olson, 26 November 1961.

[^248]: Prynne to Dorn, 17 June 1965; Prynne to Dorn, 29 November 1961.

[^249]: Prynne to Corman, 19 November 1961.

[^250]: Prynne to Dorn, 6 May 1964; Robert Creeley, ‘The Grace’,
    *Prospect*, 6 (Spring 1964), pp. 25–28.

[^251]: Latter, *Late Modernism*, pp. 25–26. As Latter points out, the
    ...
    considerations”’ (*ibid*., p. 26). It also reveals the salience of
    the term ‘formally independent’ in this thesis’s own definition.

[^252]: John James, quoted in Latter, ‘Essential news’, p. 229.

[^253]: Latter, *Late Modernism*, p. 110.

[^254]: Editorial, in *Certain Prose*, 2:5 \[373\], p. 139; editorial,
...
[^255]: This should perhaps already have been clear, given that Prynne
...
[^256]: Percy Bysshe Shelley, *A Philosophical View of Reform* (Oxford:
...
[^257]: ‘Hysteria over population’, *The Times* (6 September 1967),
...
[^258]: In the 1976 film adaptation starring Michael York, future
...
[^259]: Hugh Noyes, ‘Abortion Bill over Last Commons Hurdles: Hint on
    Conscience Clause’, *The Times* (15 July 1967), p. 2.

[^260]: Prynne to Riley, 15 September 1967.

[^261]: A brief contemporary analysis of Labour policy over welfare
    selectivity is provided in Alan Watkins, ‘About-turn on welfare’,
    *The Spectator* (22 June 1967), pp. 3–4.

[^262]: An idea of Prynne’s general attitude towards government
...
[^263]: Prynne, ‘A Letter’, in *Certain Prose*, 1:12 \[189–91\], 28–29
...
[^264]: David Chaloner, ‘Bonfire’, *The English Intelligencer*, 2.12
    (September 1967), p. 477.

[^265]: Robert V. Roosa, ‘Judging the New Liquidity Plan’, *The Banker*,
...
[^266]: Shelley to John and Maria Gisborne, 13 November 1819, in *The
    Letters of Percy Bysshe Shelley*, vol. 2, ed. by Frederick L. Jones
    (Oxford: The Clarendon Press, 1964), p. 150.

[^267]: Prynne to Riley, unattached second page of letter.

[^268]: Prynne, ‘A Note on Metal’, in *Certain Prose*, 2:1 \[286–89\],
    pp. 104–09; Riley, ‘Working Notes on British Prehistory, or
    Archaeological Guesswork One’, in *ibid*., 1:14 (supplement)
    \[234–47\], pp. 47–73.

[^269]: Prynne, ‘A Note on Metal’, in *Aristeas* (London: Ferry Press,
...
[^270]: ‘A Note on Metal’ does not appear directly adjacent to any of
...
[^271]: Latter, ‘“Scheming for the possible world”’, para. 2; Alistair
...
[^272]: Inline citations in this chapter refer to *Poems* (Tarset:
    Bloodaxe, 2015).

[^273]: Dobran, ‘J.H. Prynne’s “Aristeas, in Seven Years” and *The
    English Intelligencer*’, *Journal of British and Irish Innovative
    Poetry*, 5.2 (2013), 20–42 (p. 39, n. 15).

[^274]: G.W.F. Hegel, *Lectures on the History of Philosophy: Medieval
    and Modern Philosophy*, trans. by E.S. Haldane and Frances H. Simson
    (Lincoln, NE: University of Nebraska Press, 1995), p. 257.

[^275]: *Ibid*., p. 256.

[^276]: In fact, as will be argued later in this chapter, Prynne
    is—deliberately—even more of a materialist than Marx.

[^277]: Sutherland, ‘*Sub Songs* versus the subject: Critical variations
    on a distinction between Prynne and Hegel’, in *Hix Eros: On the
    Late Poetry of J.H. Prynne*, 123–141 (p. 129).

[^278]: The exact status of this knowledge will be considered below.

[^279]: *Ibid*., p. 124.

[^280]: James D. Muhly, ‘Sources of Tin and the Beginnings of Bronze
    Metallurgy’, *American Journal of Archaeology*, 89.2 (April 1985),
...
[^281]: ‘motive, *n*.’, *OED Online* (Oxford University Press, 2015),
    &lt;http://www.oed.com/view/Entry/122712&gt; \[accessed 18 March
    2015\].

[^282]: This attitude carries echoes of Martin Heidegger’s famous
...
[^283]: As in much of Prynne’s work, there is a potentially comic or
...
[^284]: Gregory Clark, *A Farewell to Alms: A Brief Economic History of
...
[^285]: V. Gordon Childe, *The Prehistory of European Society* (London:
    Cassell, 1962), p. 166.

[^286]: C.M. Kraay, ‘Hoards, Small Change and the Origin of Coinage’,
    *Journal of Hellenic Studies*, 84 (1964), pp. 76–91.

[^287]: This is perhaps the inverse (or the equivalent from a reversed
...
[^288]: Marx’s analysis of ‘Historical Facts about Merchant’s Capital’
...
[^289]: Prynne to Riley, 15 September 1967.
...
[^294]: As Riley puts it, ‘\[a\] theme that something existed in the
    ...
    *without* anachronism, through if anywhere this thing I hold now,
    discourse’ (Riley, ‘Working Notes on British Prehistory’, p. 48).
    The collective pronoun here refers to the readers of and
    contributors to *The English Intelligencer*.

[^295]: According to Nealon, ‘Prynne’s ambition is towards a poetry that
    would stage cognition’s ability to reverse time’ (Nealon, ‘The
    Prynne Reflex’). Nealon makes clear that ‘a belief in this ability
    organizes Prynne’s essays as well as his poems’, giving ‘A Note on
    Metal’ as a specific example (*ibid*.).

[^296]: Prynne’s explicit subject is, admittedly, metal; still, this
    does not prevent him from offering a detailed account of metal’s
    relationship with stone.

[^297]: Sutherland, ‘J.H. Prynne and Philology’, p. 189.

[^298]: *Ibid*., p. 192.

[^299]: Prynne, ‘The Art of Poetry’, p. 185.

[^300]: Sutherland, ‘J.H. Prynne and Philology’, pp. 195–96.
...
[^315]: Meillassoux, *After Finitude*, p. 10.
...
[^320]: Meillassoux, ‘Time without Becoming’ (8 May 2008),
...
[^322]: For an engagement with a similar set of issues, it is possible
    to turn to Prynne’s reading of the Anglo-Austrian physicist Wolfgang
    Rindler. Extending Rindler’s bipartite model of event-horizons and
    particle-horizons, Prynne adds an ‘inference-horizon’: ‘If we infer
    logically the existence of what we cannot observe then the inference
    horizon exceeds the event horizon by the limits of logical
    extensibility’ (Prynne to Dorn, 25 April 1972, quoted in Katko,
    p. 282). Treating the technical concept of observability loosely, we
    might say that the strictly pre-human arche-fossil sits beyond the
    event- and particle-horizons of our world, but within the bounds of
    what Prynne terms the inference-horizon.

[^323]: Meillassoux, *After Finitude*, p. 7.
...
[^351]: Douglas Oliver, *The Harmless Building* (London: Ferry Press and
    Grosseteste Review Books, 1973), p. 102; Oliver, *The Harmless
    Building*, in *Three Variations on the Theme of Harm* (London:
    Paladin, 1990), 111–255 (p. 212).
...
[^354]: ‘nympholepsy, *n*.’, *OED Online* (Oxford University Press,
    ...
    time in reference to the residents of the York Street Commune in
...
[^357]: The phrase ‘world tube’ is also used in Prynne’s contemporaneous
    ...
    *Plant Time Manifold* Transcripts’ below. Note that the plural
    ‘Ideal Weapons’, used in most sources, is incorrect.
...
[^369]: Iris Murdoch, ‘The Idea of Perfection’, *Yale Review*, 53.3
...
[^375]: *Ibid*., p. 376. Murdoch describes the notion of art ‘for its
...
[^376]: Oliver, *The Harmless Building*, p. 5; *Three Variations,*
    p. 113.

[^377]: Oliver, *The Harmless Building*, p. 143; *Three Variations*,
    p. 254.

[^378]: The connection of this vague aesthetico-ethical attitude to
...
[^379]: Prynne to Dorn, 9 September 1975. The potential fear to which
...
[^380]: The assessment conforms, for instance, to that given by Anthony
...
[^381]: The view of Upward as a quintessentially ‘thirties’ figure was
...
[^382]: New light was shed on this particular volume of the trilogy in
...
[^386]: Prynne to Barry MacSweeney, 7 August 1975.

[^387]: Upward, ‘Statement for the Literature/Sociology Conference on
    “1936” at Essex University, July 1978’, *Edward Upward*,
    &lt;http://www.edwardupward.info/pdfs/Statement.pdf&gt; \[accessed 5
    May 2015\], p. 7.

[^388]: ‘Doug Oliver was over here a short while ago and is in extreem
...
[^389]: Katherine Bucknell, ‘Introduction’, in Christopher Isherwood and
    Upward, *The Mortmere Stories* (London: Enitharmon Press, 1994),
...
[^390]: Isherwood, foreword to ‘The Railway Accident’, in Upward, *The
    Railway Accident and Other Stories* (London: Penguin, 1972), 33–35
    (pp. 33–34).

[^391]: Upward, ‘The Railway Accident’, in *The Railway Accident*, 33–84
    (pp. 61–62).

[^392]: Oliver, *The Harmless Building*, pp. 46–47; *Three Variations*,
    p. 155.

[^393]: In a 1983 journal entry, Upward gave his own inspiration as ‘a
    ...
    \[London: Enitharmon Press, 2016\], pp. 97–98). He appears to be
    referring to the 1915 Ilford rail crash, which killed ten and
    injured approximately 500 on News Year’s Day.

[^394]: Oliver, *Three Variations*, p. 115; *The Harmless Building*,
...
[^395]: Isherwood, foreword to ‘The Railway Accident’, p. 34.

[^396]: Upward, ‘The Railway Accident’, p. 40.

[^397]: Mario Faraone, ‘“Chambers of Oblivion”: I Treni di Edward Upward
    tra Allucinazione, Storia e Memoria’, in *Scorci Improvvisi di Altri
    Orizzonti*, ed. by Faraone, Martina Bertazzon, Giovanna Manzato and
    Roberta Tommasi (Morrisville, NC: Lulu, 2008), 215–34 (p. 233).

[^398]: Jameson, pp. 28–29.

[^399]: Michael Beatty, ‘The Earliest Fiction of Wyndham Lewis and *The
    Wild Body*’, *Theoria*, 48 (May 1977), 37–45 (p. 37).

[^400]: Prynne to Riley, 13 September 1967.

[^401]: Lewis, ‘Inferior Religions’, in *The Wild Body: ‘A Soldier of
    Humour’ and Other Stories* (New York: Harcourt, Brace and Company,
    1928), 233–43 (p. 233).

[^402]: *Ibid*., pp. 233–34.

[^403]: William James, quoted in Lewis, ‘The Meaning of the Wild Body’,
    in *The Wild Body*, 244–51 (p. 245); William James, *Some Problems
    of Philosophy: A Beginning of an Introduction to Philosophy*
    (Lincoln, NE: University of Nebraska Press, 1996), p. 39. For the
    author of *The Apes of God*, this realisation is perhaps related to
    the passage into the ‘realm of ape-forms and automata’ which David
    Trotter, translating Paul Celan, describes as characterising
...
[^406]: Lewis, ‘The Meaning of the Wild Body’, p. 247.

[^407]: Lewis, ‘Inferior Religions’, p. 236.

[^408]: Lewis, ‘The Meaning of the Wild Body’, p. 246. Lewis returns in
...
[^409]: Isherwood, foreword to ‘The Railway Accident’, p. 34.

[^410]: Lewis, ‘Inferior Religions’, p. 236.

[^411]: ‘The “PLANT TIME MANIFOLD” Transcripts’, *Grosseteste Review*,
...
[^412]: Prynne to Dorn, 14 March 1972, published as ‘& Hoc Genus Omne’,
...
[^413]: Katko, p. 252. A comprehensive overview of existing work on the
...
[^416]: ‘The *Plant Time Manifold* Transcripts’, in *Poems*, 233–42
...
[^417]: Drew Milne, ‘The Art of Wit and the Cambridge Science Park’, in
...
[^423]: Kingsley Amis, *Lucky Jim* (London: Victor Gollancz, 1957),
...
[^424]: Amis, *Lucky Jim*, p. 231. There are, of course, no shortage of
...
[^443]: Prynne to Robin Blaser, 28 August 1973. Speaking in Guangzhou in
...
[^446]: Prynne, *Graft and Corruption*, pp. 35–38.
...
[^450]: Tompkins and Bird, *The Secret Life of Plants*, p. 5.

[^451]: Katko, pp. 259–64; Joseph Needham, ‘Chemical Heterogony and the
    Ground-Plan of Animal Growth’, *Biological Reviews*, 9.1 (January
    1934), pp. 79–109.

[^452]: Pnina G. Abir-Am, ‘The Biotheoretical Gathering,
...
[^453]: Prynne to Oliver, 11 September 1974.

[^454]: *Ibid*., pp. 23–26.

[^455]: *Ibid*., pp. 26–27. Abir-Am acknowledges that ‘the
...
[^456]: Three of the key elements of this chapter are tied together
...
[^457]: Prynne to Dorn, 11 August 1978.

[^458]: Prynne to Dorn, 22 January 1963. A third figure in the
    ...
    the Plant Time antics’ (Prynne to Dorn, 18 March 1982).

[^459]: F.H.C. Crick and L.E. Orgel, ‘Directed Panspermia’, *Icarus*, 19
    (1973), 341–46 (p. 343).

[^460]: Prynne to Crick, 22 March 1982.

[^461]: George Puttenham, *The Arte of English Poesie* (London, 1589),
...
[^462]: Martin Priestman, *The Poetry of Erasmus Darwin: Enlightened
    Spaces, Romantic Times* (London: Routledge, 2016), p. 13.

[^463]: The metaphorical furniture of the panspermia hypothesis—seeding,
...
[^464]: According to Lewis, ‘\[t\]he creation of a work of art is an act
...
[^465]: This is not to suggest that Prynne’s thought is deliberately
...
[^466]: Needham, p. 104, quoted in Katko, p. 261.

[^467]: Prynne to Dorn, 18 March 1982.

[^468]: Pound, ‘A Few Don’ts by an Imagiste’, *Poetry* (March 1913),
    200–06 (p. 202).

[^469]: Prynne, ‘Mental Ears and Poetic Work’, p. 141. The use of
    ‘non-trivial’, a loan from the vocabulary of mathematics, is itself
    an example of such historical-contextual influence.

[^470]: Eric Falci, *The Cambridge Introduction to British Poetry,
    1945–2010* (Cambridge: Cambridge University Press, 2015), p. 3.

[^471]: Prynne, ‘Mental Ears and Poetic Work’, p. 130.

[^472]: Prynne, ‘Reading Pound: Background’, *Gonville and Caius
    College*,
    &lt;http:\slash \slash babylon.acad.cai.cam.ac.uk\slash students\slash study\slash english\slash pound\slash pound0.pdf&gt;
    \[accessed 8 January 2016\].

[^473]: Prynne, *George Herbert, ‘Love \[III\]’*, p. 16.

[^474]: Prynne, ‘A Note to Josh Kotin and Jeff Dolven’, p. 21.

[^475]: *Ibid*. The use of ‘vulgar’ here, though perhaps a deliberate
...
[^476]: *The Paris Review Interviews*, vol. 1 (New York: Picador, 2006),
    \[dustjacket\].

[^477]: ‘anecdote, *n*.’, *OED Online* (Oxford University Press, 2016),
    &lt;http://www.oed.com/view/Entry/7367&gt; \[accessed 29 June
    2016\].

[^478]: Prynne, ‘Huts’, p. 616.

[^479]: Prynne, reading (York Street Commune, Vancouver, 1 August 1971).
...
[^480]: Terry Eagleton, ‘A Toast at the Trocadero’, *London Review of
    Books*, 38.4 (18 February 2016), 9–10 (p. 10).

[^481]: Notices, in *Certain Prose*, 1:11 \[173\], pp. 24–25; ‘Roll
    Call’, in *ibid*., 1:15 \[266\], pp. 78–79.

[^482]: Not atypically for a person of his sex, generation and class,
...
[^483]: This is not to say that Mellors thinks that it can; his book is
    one study of a particular aspect of these poets’ work.

[^484]: Brady, p. 245.

[^485]: Prynne, ‘The Bee Target on his Shoulder’, in *Poems*,
    pp. 150–52.

[^486]: As Ryan Dobran points out, ‘Do not love this man’ is a direct
...
[^488]: Sutherland, ‘J.H. Prynne and Philology’, p. 215.

[^489]: Mellors, *Late Modernist Poetics*, p. 181.

[^490]: A. David Moody, *Ezra Pound: Poet: A Portrait of the Man and His
    Work*, 3 vols (Oxford: Oxford University Press, 2009–15). For
    Pound’s use of the phrase, see Pound, ‘XXIV’, in *The Cantos of Ezra
    Pound* (New York: New Directions, 1996), 110–14 (p. 112) and Pound,
    ‘LXII’, in *ibid*., 341–50 (p. 350).

[^491]: Pound, ‘XLV’, in *ibid*., 229–30 (p. 230).

[^492]: Prynne is certainly not *unaware* of issues of poetic fatherhood
    ...
    very much aware of them. Nor is he lax in his acknowledgement of
    source material in general, a notion dispelled by poems as diverse
    as ‘The Glacial Question, Unsolved’ and *Kazoo Dreamboats*. The
    point, as noted above in relation to dedications, is that he does
    not go out of his way to acknowledge specifically poetic influence,
    e.g. in matters of style, even in periods when his style has been
    recognisably derivative of, say, Olson or Tomlinson.

[^493]: Pound, ‘A Pact’, *Poetry* (April 1913), pp. 11–12.

[^494]: *Ibid*. The poem was accompanied on its second page by ‘In a
...
[^495]: Pound is perhaps even akin to the symbolic father described by
...
[^496]: This term is used in a more straightforward sense than in
...
[^497]: An obvious example of such disregard is Prynne’s discussion of
    ...
    than eight per cent. The equivalent rate for female MPs after the
...
[^498]: This is not to suggest that this position is in any way unusual
...
[^500]: Without claiming it as a ‘seal of approval’ for the statistical
...
[^504]: Prynne, ‘The Art of Poetry’, p. 207.
