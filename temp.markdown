...
the relationship in subsequent scholarship. The opposite case clearly
...
College.[^34] Alex Latter describes how Prynne’s transfer to Davie’s
...
important poet in his own right.[^35] Though the dates for the move are
...
English Verse*—as ‘a thinly disguised manifesto’.[^36] A glance at the
...
of Goldsmith’s contemporaries, and to that of my own.’[^37] The
...
Pound and perhaps Eliot.’[^38] This unabashedly conservative attitude is
...
member of the Movement.[^39] Yet despite being included in both of this
...
calls the new poetry) is \[…\] difficult to account for.’[^40] In 1959,
...
participants claimed strenuously to be ignorant.[^41] Perhaps most
...
the ash-grimed blackberries’.[^43] To recall an event from childhood is
...
“pull the trigger” when you might say “depress the mechanism”’[^44]).
...
Boris Pasternak, which I was translating at the time.’[^45] Davie is
...
1965.[^46] Far from being an invisible link, and thus not strictly an
...
was that sparked this one off as far as I’m concerned.’[^47]
...
Tomlinson on the other—at this point enters on a crucial phrase.’[^48]
...
*editors*’. Even so, it is clear that he maintains as rigorous a
...
its mission to curb population growth in the developing world.[^257] The
...
> of the imagination to be set aside.[^305]
...
> transcends itself towards it.[^310]
...
the graduated difficulties that it can provide him with’.[^311]
...
reveals.[^312] Despite making conventional concessions to science in
...
*for the human scientist*).’[^313] As Prynne asks in ‘Resistance and
Difficulty’, ‘can the world—in its full and detailed substantiality—be
said to have existed *for me*, before my knowledge of it?’[^314] The
...
Meillassoux seems to oscillate between these two perspectives, which are
really just a stronger and a weaker version of each other. Thus, in the
short paper ‘Time without Becoming’, he describes how ‘\[a\]ppeals to
...
human community.’[^317] However, it is clear from the argument of *After
...
other perceives of it.’[^318] For strong correlationism, ‘the other’ is
...
is anterior to the presently thinking subject.[^319]
...
paradigmatic example of twentieth-century religionised reason.[^322]
...
configuration.[^325] It is as if ‘A Note on Metal’ was an impossible
...
> nearest to the imagination.[^326]
...
between sections of Upward’s and Oliver’s work.[^328] In others, the
...
conventionally semiotic aspects of language.[^333] It is certainly not,
...
experience.[^334] It is at this point that Prynne brings up Lewis.
...
point.[^335] Prynne goes on to quote a paragraph from the book:
...
> his gaze stream out into space.[^336]
...
engagement, satirical or otherwise.[^337]
...
author.’[^339] Tarr is not primarily ‘an Englishman’—he is a man, first
...
prejudices of their national ethos.’[^340] By contrast, Tarr is able to
...
the expense of other characters.[^341] This is not to say that Tarr
...
working in a mature tradition.[^353] Oliver and Prynne are poets willing
...
\[learning disability charity\] Mencap’.[^355] Yet even this structure
...
pursues doggedly.[^357] Joyce might indeed be described as the exemplar
...
transit.’[^358] Assuming something similar may be said to operate in the
...
diagrammatic representation.[^359]
...
her former Oxford colleague Stuart Hampshire.[^363] Central to this
...
the outer.’[^364] Applying this rule rigorously leads to a situation in
...
written the final lines of today’.[^377]
...
> drain on energy when there’s so much else to do.’[^378]
...
> with corrugated red wattles limped from holes among the rocks.[^385]
...
have to vie with that of the real world.[^387] Nevertheless, there is a
...
maintains a fixation on the Isle of Wight.[^388] More important,
...
much of the village’s uncanny atmosphere.[^389] The same can be said of
...
for Love* (1937), without providing further details.[^394] The themes
...
primarily in rural Brittany and Spain).[^395] Apparently familiar human
...
great that it passes as open and untrammelled life.[^396] In the
...
> it is only familiarity that blunts it.’[^397]
...
Border*\] I caught from Lewis.’[^399] If Oliver is excluded, however,
...
from the observations of a *thing* behaving like a person.’[^400] As
...
oneself as just such a puppet.[^402] The characters of Mortmere appear
...
just below intuition, and life charged with black illusion.’[^404]
...
Charles Darwin’s grandfather.[^409] Nevertheless, the decision to expand
...
of co-workers’ following ‘a prolonged lunch’.[^412] Cypress,
...
offence.[^413] Lichen embarks on a long and increasingly ill-tempered
...
taken in a good deal of liquid refreshment.’[^414] Of the texts
...
Cypress’; ‘Oh indeed yes, Professor Lichen’).[^415] The characters
...
underlying this London conference.’[^416]
...
close to tenure if I want it’.[^419] As might be expected, this
...
> it’s never before 4 a.m., it’s a treadmill \[…\].[^420]
...
paintings in René Magritte’s *Le Viol* (‘The Rape’) series.[^421]
...
rarely dioecious (having separate male and female plants)?[^422] On a
...
complexity?[^423] To ask such questions is not to ‘over-read’ an
...
Quondam Lichen’.[^424] The paper having been delivered, Lichen is
greeted with ‘polite, photosynthetic applause.’[^425] Immediately, plant
...
problems of naming which have already been described.[^426] Dismissing
...
also being able to ‘metabolise’.[^427] Finally, Lichen’s collapse after
...
> between discharges of metaphoric shells.[^429]
...
of the most naive kind’.[^430] If, having followed his argument so far,
...
plants?[^431] In this sense, the *PTM* uses the metaphorical techniques
...
general and the controversy around plant sentience in particular.[^432]
...
issue of *Harper’s Magazine*.[^433] In this engagingly written but
...
> the air as if pulled by some form of antigravity, or levity.[^434]
...
been altered and its references have not been updated.’[^435] Here,
...
Time for loue of you | As he takes from you, I ingraft you new.’[^436]
...
English by default.[^437] There seems at first glance to be a ready-made
...
similarity, if not a direct etymological connection, to *nymph*.[^438]
...
> The Art it selfe, is Nature.[^439]
...
within the permitted and natural order of things.’[^440] There is,
...
conceit.”’[^441] The end result of this spiral of artificiality is to
...
Pain*.[^442] What is it about pain as a literary subject that Prynne
...
threat of future pain.[^444] In this context, pain becomes abstracted,
...
Heterogony and the Ground-Plan of Animal Growth’.[^445] Not pursued,
...
‘mathematico-physico-chemical morphology’.[^446]
...
boundaries, saw the project axed.[^447] Nevertheless, as Abir-Am
...
Biotheoretical Gathering’s brief collective discourse’.[^448] There can
...
of DNA itself.[^449] Writing to Dorn in 1978, Prynne describes a dinner
...
Wade two years earlier.[^450] In any case, Prynne was clearly in regular
...
biologist was ‘something close to genius.’[^451]
...
theory known as ‘directed panspermia’.[^452] Crick later elaborated this
theory in a monograph, *Life Itself: Its Origin and Nature* (1981), the
UK publication of which prompted a letter from Prynne.[^453] Here,
...
taste, that nature of her selfe woulde neuer haue done.’[^454] He
...
which the real-life Erasmus Darwin enthusiastically subscribed.[^455]
...
Building*, a body which is identified partly with that of his son.[^456]
...
scrupulously signed and dated.[^457] The link to Prynne’s implicit
...
panspermia.[^458] The same can be said of his attitude to metaphor,
...
growth’—is a key feature of the *PTM*’s biochemical hinterland.[^459] In
...
and only that is the source of novelty.”’[^460] \newpage
...
pursuit’.[^462] Introducing the recent *Cambridge Introduction to
...
marbled by its context.’[^463] Falci’s simultaneous disavowal both of
...
understand everything!’[^464] Yet in his own published and unpublished
...
two separate references for further material about Pound’s life.[^465]
...
author for a forthcoming issue of *The Paris Review*.’[^467] Here,
...
> work will open up many kinds of interiority, yours and mine.[^468]
...
record of the writing life.’[^469] It is Prynne’s first substantial
...
unpublished’.[^470]) Near the beginning of the essay, for example,
...
under the floorboards’.[^471] Later, he describes visiting huts in
...
time on anecdotes than on the poems themselves.[^472]
...
> T.S., W.B., E.M., D.H., L.P., W.H. and so on.’[^473]
...
R.F. Langley.[^474] In Prynne’s case, that tradition might owe as much
...
male-dominated.[^475] Even so, its contention has been that Prynne’s
...
Modernist Poetics*.[^476] Andrea Brady is right to point out that such
models risk becoming ‘fantasies of all-male reproduction’, particularly
when extended into the present.[^477] Yet, in what is perhaps itself a
...
the figure of the father, using the word itself four times.[^478] In
...
double back in the poem’s third act: ‘Love him’ (84).[^479] The
...
interrupt’.[^481] Thus, in the poem’s final stages, an overbearingly
...
boots | on the lawn’.[^482] The pseudo-Victorianism of this passage—its
...
work.[^483] What, then, is the structure of this ‘haunting’, and what
...
the child in the womb’.[^484] Pound is, however, much more ready than
Prynne to acknowledge direct poetic influence.[^485] The most famous
...
wood, | Now is a time for carving.’[^486] Prynne’s *oeuvre* contains no
...
successively shrinking sub-fathers.[^487] The apparent genealogical
...
androcentric.[^488] Descent is based structurally on the male side of
the reproductive process, with almost no regard for the female.[^489]
...
drop-off thereafter.[^491] For reference, the chronological scope of
...
purposeful mutation.’[^493] This implicitly genetic model, in which the
...
> incarnations, in cherishment and in trust.[^494]
...
intrinsically hard to recognize accurately’.[^495] Part of this
...
position is not reserved from any of the moral damage’.[^496] As long as
...
Vinen, Richard, *National Service: Conscription in Britain, 1945–1963*
...
[^31]: Prynne, ‘A Dialogue with Nicholas Royle’.
...
[^33]: Davie, *Ezra Pound: Poet as Sculptor* (Oxford: Oxford University
...
[^36]: Donald Davie, *Articulate Energy: An Inquiry into the Syntax of
    English Poetry* (London: Routledge & Kegan Paul, 1976), p. ix.

[^37]: Davie, *Purity of Diction in English Verse* (London: Chatto &
    Windus, 1952), p. 2.

[^38]: Davie, *Articulate Energy*, p. ix. In fairness, Davie is
...
[^39]: ‘In the Movement’, *The Spectator* (30 September 1954),
    pp. 21–22.

[^40]: Charles Tomlinson, ‘The Middlebrow Muse’, *Essays in Criticism*,
    7.2 (April 1957), 208–17 (p. 213).

[^41]: Davie, ‘Remembering the Movement’, in *The Poet in the Imaginary
    Museum: Essays of Two Decades*, ed. by Barry Alpert (Manchester:
    Carcanet, 1977), pp. 72–75.

[^42]: Davie, *Events & Wisdoms* (London: Routledge & Kegan Paul, 1964),
...
[^43]: Davie, ‘Housekeeping’, in *Collected Poems* (Manchester:
    Carcanet, 1990), p. 104.

[^44]: Richard Vinen, *National Service: Conscription in Britain,
...
[^312]: Meillassoux, *After Finitude*, p. 10.
...
[^320]: Meillassoux, *After Finitude*, p. 7.
...
[^351]: ‘nympholepsy, *n*.’, *OED Online* (Oxford University Press,
...
[^371]: Oliver, *The Harmless Building*, p. 143; *Three Variations*,
    p. 254.
...
[^388]: Oliver, *Three Variations*, p. 115; *The Harmless Building*,
...
[^398]: Oliver, *The Harmless Building, pp. 61, 78; *Three Variations\*,
    pp. 170, 188.
...
[^419]: Prynne to Dorn, 10 January 1972.

[^420]: Prynne to Dorn, 5 March 1975.

[^421]: Another Magritte painting, *La Durée poignardée* (‘Time
    Transfixed’), is used on the cover of the 1972 Penguin edition of
    Upward’s *The Railway Accident*.

[^422]: *PTM*, p. 238. This is perhaps the most obvious respect in which
...
[^423]: The issue of prejudice is of course taken up in the seminar
...
[^429]: Hugh Kenner, ‘Wyndham Lewis: The Satirist as Barbarian’, *The
    Yearbook of English Studies*, 14 (1984), 264–75 (p. 269).

[^430]: *PTM*, p. 236–37.

[^431]: This moment of realisation is akin to what Kenner describes as
...
[^432]: Key environmentalist milestones in this period include the
...
[^433]: Peter Tompkins and Christopher Bird, ‘Love among the cabbages’,
    *Harper’s Magazine* (November 1972), pp. 90–92, 94–96.

[^434]: Tompkins and Bird, *The Secret Life of Plants* (New York: Harper
    & Row, 1973), p. x.

[^435]: Prynne, *Graft and Corruption: Shakespeare’s Sonnet 15*
...
[^436]: William Shakespeare, *Shake-speares Sonnets Neuer before
    Imprinted* (London, 1609), sig. B~4~^r^, quoted in Prynne, *Graft
    and Corruption*, p. 12.

[^437]: Prynne to Robin Blaser, 28 August 1973. Speaking in Guangzhou in
...
[^438]: Prynne, *Graft and Corruption*, p. 31. For demonstrations of
...
[^439]: Shakespeare, *The Winter’s Tale* (Folio, 1623), IV.iv.89–97
    (sig. Bb~2~^v^), quoted in Prynne, *Graft and Corruption*, p. 34.

[^440]: Prynne, *Graft and Corruption*, pp. 35–38.

[^441]: *Ibid*., p. 37.

[^442]: A.V.S. de Reuck and Julie Knight, eds, *Touch, Heat and Pain*
...
[^443]: Elaine Scarry, *The Body in Pain: The Making and Unmaking of the
    World* (Oxford: Oxford University Press, 1985), p. 3. The geological
    metaphor adopted here would no doubt appeal to Prynne.

[^444]: Tompkins and Bird, *The Secret Life of Plants*, p. 5.

[^445]: Katko, pp. 259–64; Joseph Needham, ‘Chemical Heterogony and the
    Ground-Plan of Animal Growth’, *Biological Reviews*, 9.1 (January
    1934), pp. 79–109.

[^446]: Pnina G. Abir-Am, ‘The Biotheoretical Gathering,
...
[^448]: *Ibid*., pp. 26–27. Abir-Am acknowledges that ‘the
...
[^449]: Three of the key elements of this chapter are tied together
...
[^450]: Prynne to Dorn, 11 August 1978.

[^451]: Prynne to Dorn, 22 January 1963. A third figure in the
...
[^452]: F.H.C. Crick and L.E. Orgel, ‘Directed Panspermia’, *Icarus*, 19
    (1973), 341–46 (p. 343).

[^453]: Prynne to Crick, 22 March 1982.

[^454]: George Puttenham, *The Arte of English Poesie* (London, 1589),
...
[^455]: Martin Priestman, *The Poetry of Erasmus Darwin: Enlightened
    Spaces, Romantic Times* (London: Routledge, 2016), p. 13.

[^456]: The metaphorical furniture of the panspermia hypothesis—seeding,
...
[^457]: According to Lewis, ‘\[t\]he creation of a work of art is an act
...
[^458]: This is not to suggest that Prynne’s thought is deliberately
...
[^459]: Needham, p. 107, quoted in Katko, p. 261.

[^460]: Prynne to Dorn, 18 March 1982.

[^461]: Pound, ‘A Few Don’ts by an Imagiste’, *Poetry* (March 1913),
    200–06 (p. 202).

[^462]: Prynne, ‘Mental Ears and Poetic Work’, p. 141. The use of
    ‘non-trivial’, a loan from the vocabulary of mathematics, is itself
    an example of such historical-contextual influence.

[^463]: Eric Falci, *The Cambridge Introduction to British Poetry,
    1945–2010* (Cambridge: Cambridge University Press, 2015), p. 3.

[^464]: Prynne, ‘Mental Ears and Poetic Work’, p. 130.

[^465]: Prynne, ‘Reading Pound: Background’, Gonville and Caius College,
    &lt;http:\slash \slash babylon.acad.cai.cam.ac.uk\slash students\slash study\slash english\slash pound\slash pound0.pdf&gt;
    \[accessed 8 January 2016\].

[^466]: Prynne, ‘George Herbert, “Love \[III\]”’, p. 16.

[^467]: Prynne, ‘A Note to Josh Kotin and Jeff Dolven’, p. 21.

[^468]: *Ibid*. The use of ‘vulgar’ here, though perhaps a deliberate
...
[^469]: *The Paris Review Interviews*, vol. 1 (New York: Picador, 2006),
    \[dustjacket\].

[^470]: ‘anecdote, *n*.’, *OED Online* (Oxford University Press, 2016),
    &lt;http://www.oed.com/view/Entry/7367&gt; \[accessed 29 June
    2016\].

[^471]: Prynne, ‘Huts’, p. 616.

[^472]: Prynne, reading (York Street Commune, Vancouver, 1 August 1971).
...
[^473]: Terry Eagleton, ‘A Toast at the Trocadero’, *London Review of
    Books*, 38.4 (18 February 2016), 9–10 (p. 10).

[^474]: Notices, in *Certain Prose*, 1:11 \[173\], pp. 24–25; ‘Roll
    Call’, in *ibid*., 1:15 \[266\], pp. 78–79.

[^475]: Not atypically for a person of his sex, generation and class,
...
[^476]: This is not to say that Mellors thinks that it can; his book is
    one study of a particular aspect of these poets’ work.

[^477]: Brady, p. 245.

[^478]: Prynne, ‘The Bee Target on his Shoulder’, in *Poems*,
    pp. 150–52.

[^479]: As Ryan Dobran points out, ‘Do not love this man’ is a direct
...
[^481]: Sutherland, ‘J.H. Prynne and Philology’, p. 215.

[^482]: Mellors, *Late Modernist Poetics*, p. 181.

[^483]: A. David Moody, *Ezra Pound: Poet: A Portrait of the Man and His
...
[^484]: Pound, ‘XLV’, in *ibid*., 229–30 (p. 230).

[^485]: Prynne is certainly not *unaware* of issues of poetic fatherhood
...
[^486]: First appearing as Pound, ‘A Pact’, *Poetry* (April 1913),
...
[^487]: Pound is perhaps even akin to the symbolic father described by
...
[^488]: This term is used in a more straightforward sense than in
...
[^489]: An obvious example of such disregard is Prynne’s discussion of
...
[^490]: This is not to suggest that this position is in any way unusual
...
[^491]: The usage of similar terms such as ‘human’ or ‘woman’ across the
...
[^492]: Without claiming it as ‘seal of approval’ for the statistical
...
[^493]: Prynne to Oliver, 5 September 1994.

[^494]: Prynne, ‘The Poet’s Imaginary’, p. 104.

[^495]: Prynne, *ibid*., p. 96.

[^496]: Prynne, ‘The Art of Poetry’, p. 207.
