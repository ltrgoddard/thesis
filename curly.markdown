...
corresponded throughout the 1960s.[^1] Yet the relationship between the
...
direction.’[^2] Leaving aside the misleading reference to the ‘British
...
influence.[^3] Unlike Olson, Davie is only ‘gently’ modernist; Prynne,
...
work.”’[^5] He goes on to cite Reeve and Kerridge’s *Nearly Too Much*,
...
mature.[^6] More recent investigations into what has been described as
...
push this work even further into obscurity.[^7]
...
influences in work on Prynne’s early career.[^8] It is true that Prynne
...
prose as his relationships with Olson and, later, Ed Dorn.[^9]
...
accessible collection at the University of Connecticut.[^10] It is
...
the relationship in subsequent scholarship.[^11] The opposite case
...
Davie’s 1964 book on Ezra Pound.[^12]
...
College.[^13] Alex Latter describes how Prynne’s transfer to Davie’s
...
important poet in his own right.[^14] Though the dates for the move are
...
English Verse*—as ‘a thinly disguised manifesto’.[^15] A glance at the
...
of Goldsmith’s contemporaries, and to that of my own.’[^16] The
...
Pound and perhaps Eliot.’[^17] This unabashedly conservative attitude is
...
member of the Movement.[^18] Yet despite being included in both of this
...
calls the new poetry) is […] difficult to account for.’[^19] In 1959,
...
participants claimed strenuously to be ignorant.[^20] Perhaps most
...
the ash-grimed blackberries’.[^22] To recall an event from childhood is
...
“pull the trigger” when you might say “depress the mechanism”’[^23]).
...
Boris Pasternak, which I was translating at the time.’[^24] Davie is
...
1965.[^25] Far from being an invisible link, and thus not strictly an
...
was that sparked this one off as far as I’m concerned.’[^26]
...
on the other—at this point enters on a crucial phrase.’[^27]
...
rife. Look at Gunn.’[^28] The collocation with Thom Gunn is particularly
...
carry a review […]—pressures inherited that I can’t side-step.’[^29] It
...
musculature of most English writers of verse’.[^30] It is perhaps
...
one of simultaneous fascination and alienation.[^31] In the sequence’s
...
| And envy you out of England.’[^32] A further poem, added to the
...
British, one sympathizes.’[^33] It seems possible that Prynne’s
...
academic of such intelligence and standing as him.’[^35] While this
...
an idiot.[^36] Prynne’s next letter to Dorn, in July, helpfully
...
small conviction he can command.’[^37] He admits that Davie ‘has visions
...
what is true of the public context in which we live.’[^38] It is odd to
...
doubt”, “I suppose”, “of course”, “almost”, “perhaps”’.[^39] This is
...
outside of the | shopping-bag’.[^40] When we encounter the ‘inert
...
much difficulty.’[^42] Discussing the same subject with Dorn in
...
published there and know the man in question [Colin Franklin].’[^43] In
...
Guardian*.’[^44] The tone here is like a less direct and militaristic
...
‘with you as general, the boys could move right into control.’[^45]
...
> of Spender’s new and worthless book.[^46]

Davie’s review, a cutting of which is pasted into the letter, combines
traditional, Movement-style antipathy towards Stephen Spender, Dylan
Thomas and anyone else associated with the 1940s with enthusiasm for
‘the theories of Olson and the poems of Creeley and Edward Dorn [which]
...
new in America at this time, but I am working steadily at him’.[^48] At
...
of distance’.[^49] This ambivalence is maintained throughout the decade.
...
well.’[^50] Yet when Davie makes his momentous move to the United States
...
Cal.’[^51] Prynne’s ambivalence towards Davie was described above as
...
other’s verse.’[^52] That Prynne enjoyed a similarly free relationship
...
While brief, this account carries a clear sense of scholarly community:
an implication, particularly in the gentle humour of the final sentence,
that the undergraduate may speak on equal terms with the celebrated
poet.
...
their characterisation as ‘middlebrow’.[^54] The anthology’s
...
‘journalist in verse’.[^55] Aside from some similarly dismissive
...
manner’, though he is kept in his place as ‘a good but minor poet’.[^56]
...
objective values in our criticism.’[^57]
...
throw down *any* safeguard.’[^58] It is Enright’s piece which deals the
...
> ‘fellow-travellers’ would be, once applied for a ticket?[^59]
...
the attention of his then publishers’.[^61] Prynne’s letter to Dorn of
...
he refused to do the same (or more) for his own student.[^62] The second
...
Stevens.’[^63] Broadcasting on the Third Programme was in fact a
...
(Corpus Christi) on Martin Heidegger.[^64] Nevertheless, it seems likely
...
translation of the *Odyssey*.[^65]) The last of Davie’s potential
...
publication of selected interviews in a 1966 volume edited by Orr.[^66]
...
one side, and Ingeborg Bachmann or Paul Celan on the other.’[^68] In a
...
successor to Auden’s)’.[^69] This last statement offers a solution to
...
door-nail would be, given any decent chance.’[^70] It is instructive to
...
the tone for his subsequent work.[^71] Prynne and Tomlinson both clearly
...
in a trick they hoped to play on their supporters.’[^72] Just as Amis
...
Circumstance*.[^73] That Prynne decided, from the late 1960s, to forego
...
and worthy of study.[^74] As was demonstrated at the beginning of this
...
F.R. Leavis and his wife Queenie.’[^75] Prynne and F.R. Leavis are very
...
‘followers’, for want of a better term.[^76] Responding to a piece by
...
and my time in the UK still adds up to far less than half my life.’[^77]
...
> Milne, Ian Patterson, Denise Riley and John Wilkinson.[^78]

After moving into university teaching positions, many of the poets
mentioned above have been involved, consciously or otherwise, in the
creation of a nascent academic infrastructure—critical books,
...
three in the year 1948 alone.[^79] A memoir written by one of the three
...
prepare pupils for Leavis’s notoriously exacting scholarship exams.[^80]
If Leavis was a distinct presence in Prynne’s schooling, what of his
undergraduate course? Prynne’s friendship with coursemate Roger Langley
and their request for supervision by Davie, who had himself been taught
by Leavis in the late 1940s, has been described above. It is less clear
who else supervised Prynne during this period. As mentioned above,
Prynne’s college tutor at the time was Laurence Picken, and while this
is usually a pastoral role Prynne has made clear that Picken ‘taught me
my first beginnings of Chinese and encouraged me to help him with
translations of some poetic texts.’[^81] In terms of formal academic
supervision, however, there are a number of more obvious candidates. The
Shakespeare scholar Philip Brockbank served as a college lecturer at
Jesus from 1954 to 1958, before moving to the universities of Reading
and York.[^82] Brockbank was closely associated with Leavis during his
tenure at the latter institution, though it is not clear how well the
two men knew each other in the late 1950s. The Scottish literary
historian David Daiches was, meanwhile, appointed fellow of Jesus in
1957, presumably to fill the teaching gap left by the death of A.P.
Rossiter in the same year. Listed as Director of Studies in English in
the college’s 1959 annual report, Daiches again raises the spectre of
Leavis, albeit in a negative fashion.[^83] Janet Burroway, a
...
slight, from which the subsequent reflection springs.[^85] By contrast,
...
means of focussing one’s attention but of diffusing it.’[^86] Prynne
...
> force not to be surpassed by anything but reality.[^87]
...
poet from his most valuable material’.[^88] At first glance, this
...
to use is no longer ‘shared’ in any real sense.[^89] Importantly, Prynne
and Leavis not only provide common diagnoses of the disjunct between
poetic language and the world in which it is written, but also provide
remarkably similar assessments of the texture of this language—what it
feels like to read. ‘Nineteenth-century poetry,’ writes Leavis, ‘[…] was
characteristically preoccupied with the creation of a dream-world.’[^90]
Where Prynne describes meditative poetry as ‘narcotic’, Leavis notes
that, in a piece of ‘late Victorian poetastry’ by Andrew Lang, ‘it is
the music of the languid hours that predominates’.[^91] Leavis even
identifies Tennyson as a paradigmatic example of the tendency:
...
> protest is worth making except the protest of withdrawal.[^92]
...
meditative.[^93] Eliot is considered in more detail at the very end of
...
emotional modality is largely neutralized.’[^94] There is a parallel
here with Leavis’s assessment of Eliot’s *Gerontion* in the third
chapter of *New Bearings*, where he praises the poem’s ‘really dramatic
detachment’: ‘From a position far above his immediate concerns as a
particular individual, projecting himself, as it were, into a
comprehensive and representative human consciousness, the poet
contemplates human life and asks what it all comes to.’[^95] Yet where
...
of Prynne’s own first collection of poems.[^97]
...
‘perhaps alludes to Hardy’s *Satires of Circumstance*’.[^98] In the
...
substantially in doubt.[^99] Given this, it is not too much of a stretch
to read the valorisation of ‘force of circumstance’ as an anti-Romantic
(though not quite anti-Wordsworthian), Movement-style exhortation to
modesty: an injunction not to interfere unduly with the forces that
shape circumstance, but simply to observe and to record them.[^100] This
certainly seems to be force of the phrase in the collection’s titular
poem, in which the speaker reflexively contemplates his or her own
memory of a ‘broken, idle mill-wheel’, repeatedly refusing to modify the
image by making the wheel turn, or even by imagining the reconstruction
of ‘the rotting chute | That brought the water to it’ in order to allow
it to turn of its own accord. For the speaker, ‘the force | Of
circumstance […] protects the place’, preventing any such interference,
though at the poem’s conclusion he or she is permitted to ‘set a heron
down, a tense | And watchful silence’ which figures the speaker’s own
position as observer.[^101]
...
necessarily come about.’[^102] This ambiguous solution to what has been
...
acknowledged a profound debt.[^103] What, then, does Prynne mean when he
...
bugbear.[^104] Bloomsbury is again attacked in a 1962 letter to Dorn,
...
sort of curious and sinister joke.’[^105] Leavis’s opposition to
...
associated with *The English Intelligencer*.[^106] Both attitudes seem
...
feline charm or a sensual mouth and long eyelashes.’[^107] Prynne, in a
...
is more overtly homophobic.[^108]
...
“culture” I mean the use of such a language.’[^109] On a purely
...
> find it there and reclaim it for those who will stop to read.[^111]
...
by the constant verb.’[^112] This, in turn, recalls both the argument
...
define its own contour’.[^113] The most important five words of the
...
similarities where they arise.[^114]
...
(sectional) into | *need* (social & then total)’.[^115] Referring to a
...
published, like Prynne’s “Warning”, in 1967.’[^116] The comparison is
...
in *IS*, was authored by Debord.[^117] Nevertheless, it would be
...
published the previous month.[^118] Edited by Stuart Hall, E.P. Thompson
...
Left.’[^119] Prynne clearly considered it important enough for Riley to
...
“want” is being created in thousands of homes.’[^120] The scope of
...
a 1959 *Critical Quarterly* symposium on ‘Our Debt to Dr. Leavis’.[^122]
...
20th century.[^123] Crucially, the *Economic and Philosophical
...
Ágnes Heller’s *The Theory of Need in Marx* in 1976.[^124]
...
future of an increasingly consumerist British society.[^125] Discussing
...
desires’ is clear. If this attitude can plausibly be linked to a French
intellectual *milieu* still relatively obscure in the Britain of the mid
1960s (the first English translation of Debord’s *Society of the
...
less than a decade earlier.[^127] Fuller begins the lecture with two
...
> we are not to ask what the tree is.[^128]

Making use of a biological metaphor himself, Leavis summarises what he
opposes in Shelley as ‘a general tendency of the images to forget the
status of the metaphor or simile that introduced them and to assume an
autonomy and a right to propagate, so that we lose in confused
generations and perspectives the perception or thought that was the
ostensible *raison d’être* of imagery’.[^129] Having quoted Leavis at
...
uncongenial.’[^132] What he puts in question is ‘whether the second
...
critical response.’[^133] The tone of the letter (‘And I should have
...
> out of ideas astonishingly disregarded at the present time.[^135]
...
corpus, connecting the works along a thin thread of biography.’[^136]
...
onwards.[^138] All three of these texts are structured as meticulous,
...
three commentaries consider poems of which Prynne approves).[^139] This
...
same issue of *The Hudson Review* as ‘The World as Meditation’.[^140] In
...
imagery’.[^141] Having referred directly to ‘the English Romantic poets,
...
metaphor, Stevens is fundamentally a similar poet to Shelley.[^143] By
the same token, it seems fair to say that the Prynne who writes so
approvingly of Stevens in 2014 is more or less the same as the Prynne
...
colleges.[^144] His biographer, Ian MacKillop, summarises the precarity
...
over fifty years old.’[^145] Leavis was not made a fellow at Downing
until 1936, at the age of 41, five years after starting work at the
college.[^146] His most important critical work, meanwhile, was not
...
> and survived in spite of Cambridge.[^147]
...
feels like death.’[^148] Prynne characterises the offer as a result of
...
irrelevance.’[^149] Importantly, Prynne presents his acceptance of the
...
accurately before them.’[^150] This attitude reappears clearly in almost
...
areas.[^151] For the twenty-seven-year-old Prynne, who had recently
...
university libraries’.[^152] He proceeds to disabuse Clark of this
...
Leavis’s ‘Two Cultures?’ the previous year.[^153] Nevertheless, there is
...
certainly more important than those of politics and bureaucracy. This
view is certainly consonant with Leavis’s conception of the university
as ‘a real and vital centre of consciousness’ and his opposition to ‘the
publicizers, public relations men, heads of houses, academic
ward-bosses, hobnobbers with Cabinet ministers, who are planning, they
tell us, to remodel the University and start going a new kind of higher
education.’[^154]
...
2011.[^155] To the extent that this period involved intense public
...
deep and permanent damage.’[^156] He also appeals repeatedly to the
...
implicitly justify the *status quo*: all change is bad change.[^157]
...
bureaucratic state intervention.[^158] Writing to Dorn in 1972, Prynne
declares that Cambridge ‘should never have’ given him a permanent job as
he ‘won’t ever produce the gavotte required’.[^159] While this is true
...
a certain level of academic influence.[^160]
...
study as moral training for citizenship.’[^161] Solomon’s reading is
...
The evident sincerity of this text makes using it to shore up a
scholarly point about Prynne’s intellectual influences seem churlish.
...
between Leavis and F.W. Bateson in the pages of *Scrutiny*.[^163]
...
the Anatomy of Satire* (1953).[^164] His point, which he makes with
...
the common reader.’[^165] Yet he presents the work of Leavis and
...
for them to use.’[^168] He goes on to argue, in effect, for the gradual
...
> or to use methods derived from *Scrutiny*.[^169]
...
little over the course of the next four-and-a-half decades.[^170] Prynne
...
sociology of education as to a history of literary values.’[^171]
\newpage

[^1]: Jeremy Noel-Tod, ‘Prynne, J. H. (Jeremy Halvard)’, in *The Oxford
...
[^2]: ‘Prynne, J.H.’, in *The Concise Oxford Companion to English
    Literature*, 4th edn, ed. by Dinah Birch and Katy Hooper (Oxford:
    Oxford University Press, 2012), p. 574.

[^3]: Eric Mottram, ‘The British Poetry Revival 1960–1975’, in *New
...
[^4]: J.H. Prynne, *Poems*, 3rd edn (Tarset: Bloodaxe, 2015), referrred
    to hereafter as *Poems*.

[^5]: Sutherland, ‘J.H. Prynne and Philology’, p. 238; Ian Patterson,
    ‘“the medium itself, rabbit by proxy”: some thoughts about reading
    J.H. Prynne’, in *Poets on Writing, 1970–1991* (London: Macmillan,
    1992), 234–46 (p. 237).

[^6]: Arguing against Anthony Mellors, Sutherland takes a version of the
    latter position, further disagreeing with Reeve and Kerridge over
    the precise character of the break: ‘It is in my view misleading to
    speak of “changes … introduced” by Prynne as if these were
    calculated reforms. It is also misleading to suggest that these
...
[^7]: *Hix Eros: On the Late Poetry of J.H. Prynne*, ed. by Joe Luna and
    Jow Lindsay Walton (Brighton: Hi Zero and Sad Press, 2014).

[^8]: Steve Clark, ‘Prynne and the Movement’, *Jacket*, 24 (November
    2003), \<http://jacketmagazine.com/24/clark-s.html\> [accessed 27
    November 2014].

[^9]: J.H. Prynne, ‘A Dialogue with Nicholas Royle’ (seminar, University
    of Sussex, 11 March 2014).

[^10]: By contrast, Prynne’s correspondence with Tomlinson is only
...
[^11]: It would be instructive to make a detailed comparison of Prynne’s
...
[^12]: Davie, *Ezra Pound: Poet as Sculptor* (Oxford: Oxford University
...
[^15]: Donald Davie, *Articulate Energy: An Inquiry into the Syntax of
    English Poetry* (London: Routledge & Kegan Paul, 1976), p. ix.

[^16]: Davie, *Purity of Diction in English Verse* (London: Chatto &
    Windus, 1952), p. 2.

[^17]: Davie, *Articulate Energy*, p. ix. In fairness, Davie is
...
[^18]: ‘In the Movement’, *The Spectator* (30 September 1954),
    pp. 21–22.

[^19]: Charles Tomlinson, ‘The Middlebrow Muse’, *Essays in Criticism*,
    7.2 (April 1957), 208–17 (p. 213).

[^20]: Davie, ‘Remembering the Movement’, in *The Poet in the Imaginary
    Museum: Essays of Two Decades*, ed. by Barry Alpert (Manchester:
    Carcanet, 1977), pp. 72–75.

[^21]: Davie, *Events & Wisdoms* (London: Routledge & Kegan Paul, 1964),
...
[^22]: Davie, ‘Housekeeping’, in *Collected Poems* (Manchester:
    Carcanet, 1990), p. 104.

[^23]: Richard Vinen, *National Service: Conscription in Britain,
    1945–1963* (London: Allen Lane, 2014), p. 156.

[^24]: Davie, ‘A Reading of His Poems’ (reading, University of
...
[^25]: Davie, *The Poems of Doctor Zhivago* (Manchester: Manchester
    University Press, 1965).

[^26]: Davie, ‘A Reading of His Poems’.

[^27]: Davie, ‘NOVEMBER 14th, 1958’. Full references for all archival
    materials cited in this thesis, including letters, are provided
    chronologically by name in the bibliography.

[^28]: Prynne’s use of underlining in letters, both for titles and for
    emphasis, has been standardised to italics throughout this thesis.

[^29]: Prynne to Cid Corman, 19 November 1961. It is worth noting that
...
[^30]: Prynne, ‘from a letter’, *Mica*, 5 (Winter 1962), 2–3, 28
...
[^31]: Davie, *Collected Poems, 1950–1970* (London: Routledge & Kegan
    Paul, 1972), p. 303.

[^32]: Davie, ‘A Letter to Curtis Bradford’, in *Collected Poems*
    (Manchester: Carcanet, 1990), 98–99 (p. 99).

[^33]: Davie, ‘For Doreen. A Voice from the Garden’, in *ibid*.,
    pp. 99–100 (p. 100).

[^34]: Whatever his antipathy towards the sequence in 1961, Prynne did
    at least send a copy to Dorn, suggesting a certain level of interest
    (Dorn to Olson, 3 March 1965).

[^35]: Prynne to Ed Dorn, 29 April 1962. In an interesting slip, Prynne
    refers to *The Newly Fallen* as ‘*For the Unfallen*’, the title of a
    1959 collection by Geoffrey Hill.

[^36]: ‘Elections to Fellowships’, *The Caian* (Lent 1963), p. 33.
    Latter, *Late Modernism and ‘The English Intelligencer’* (London:
    Bloomsbury, 2015), p. 239, n. 4.

[^37]: Davie, ‘Remembering the Movement’, p. 74.

[^38]: Prynne to Dorn, 9 July 1962.

[^39]: Davie, ‘Remembering the Movement’, p. 72.

[^40]: Prynne, ‘A Gold Ring Called Reluctance’, in *Poems* (Tarset:
    Bloodaxe, 2015), 21–23 (p. 22).

[^41]: *Ibid*., p. 23; John Press, *Rule and Energy: Trends in British
...
[^42]: Prynne to Olson, 7 November 1962.

[^43]: Prynne to Dorn, 31 December 1962.

[^44]: Prynne to Dorn, 10 December 1962.

[^45]: Kingsley Amis, quoted in Zachary Leader, *The Life of Kingsley
    Amis* (London: Random House, 2013), p. 284.

[^46]: Prynne to Dorn, 14 April 1963.

[^47]: Davie, ‘Spender Struggling’, *The New Statesman*, 65 (29 March
    1963), p. 465.

[^48]: Prynne to Dorn, 10 December 1962.

[^49]: Prynne to Olson, 24 April 1963; Prynne to Dorn, 17 June 1965.

[^50]: Prynne to Peter Riley, 9 August 1967.

[^51]: Prynne to Riley, 7 February 1968.

[^52]: Willard Spiegelman, ‘Charles Tomlinson, The Art of Poetry No.
...
[^53]: ‘The Literary Society’, *Fifty-Fifth Annual Report* (Cambridge:
...
[^58]: Donald Davie and D.J. Enright, ‘*New Lines* and Mr. Tomlinson’,
    *Essays in Criticism*, 7.2 (April 1957), 343–45 (pp. 343–44).

[^59]: *Ibid*., p. 345.

[^60]: Martin Dodsworth, ‘The Movement: Never and Always’, in *The
    Oxford Handbook of Contemporary British and Irish Poetry*, ed. by
    Peter Robinson (Oxford: Oxford University Press, 2013), 94–110
    (p. 103).

[^61]: Marriott, p. 81, n. 8.

[^62]: Prynne to Dorn, 31 December 1962.

[^63]: Schedule, *Radio Times* (13 December 1962), p. 13.

[^64]: Schedule, *Radio Times* (6 December 1962), p. 49. It would,
...
[^65]: David Daiches, another of Prynne’s potential supervisors at
    Jesus, was also a regular feature on the Third Programme throughout
    the 1950s and ’60s.

[^66]: Peter Orr, ed., *The Poet Speaks: Interviews with Contemporary
    Poets* (London: Routledge & Kegan Paul, 1966). Prynne’s interview
    was not included in this book.

[^67]: Prynne interviewed by Peter Orr, *The Poet Speaks*, Programme 39
    (6 January 1964).

[^68]: Prynne, ‘“Modernism” in German Poetry’, *The Cambridge Review* (9
    March 1963), 331–37 (p. 337).

[^69]: Prynne, ‘from a letter’, p. 3; Prynne to Olson, 4 November 1961.
...
[^70]: Prynne to Olson, 9 September 1962.

[^71]: Spiegelman, ‘Charles Tomlinson, The Art of Poetry No. 78’. Prynne
...
[^75]: Prynne and Keston Sutherland, ‘Introduction to Prynne’s Poems in
...
[^76]: Prynne did in fact begin a doctoral thesis on the work of Thomas
    Hardy, but only completed one year of research before his election
    (Johansson, p. 67, n. 66).

[^77]: Andrea Brady, letter, *Cambridge Literary Review*, 1.2 (Lent
    2010), 244–49 (p. 244).

[^78]: Nigel Wheale, ‘Cambridge School, The’, in *The Oxford Companion
...
[^79]: Christopher Hilliard, *English as a Vocation: The ‘Scrutiny’
...
[^80]: David Matthews, *Memories of F.R. Leavis* (Bishopstone: Edgeways
    Books, 2010), p. 4.

[^81]: Prynne and Sutherland, p. 201.

[^82]: ‘Papers Relating to “Players of Shakespeare”’, *Archives Hub*,
...
[^83]: *Fifty-Fifth Annual Report* (Cambridge: Jesus College Cambridge
    Society, 1959), p. 44.

[^84]: Janet Burroway, ‘Was Too: Time Passed with David Daiches’, in
...
[^85]: Prynne, ’The Elegiac World in Victorian Poetry’, *The Listener*
    (14 February 1963), 290–91 (p. 290).

[^86]: *Ibid*., pp. 290–91. Prynne here exhibits a style of argument
...
[^87]: John Stuart Mill, quoted in *ibid*., p. 291; Mill, ‘Tennyson’s
...
[^88]: F.R. Leavis, *New Bearings in English Poetry: A Study of the
    Contemporary Situation* (London: Chatto & Windus, 1932), p. 12.

[^89]: Prynne, ‘The Elegiac World’, p. 290. Similar points are often
...
[^90]: Leavis, *New Bearings*, p. 10. The astonishing audacity of this
...
[^93]: Prynne, ‘The Elegiac World’, p. 290.

[^94]: *Ibid*., p. 291. Prynne’s position *vis-à-vis* Eliot is made much
    clearer in the 1962 letter to the little magazine *Mica* cited
...
[^95]: Leavis, *New Bearings*, p. 83.

[^96]: Prynne, ‘The Elegiac World’, p. 291. The sense of Eliot as
...
[^98]: Clark, ‘Prynne and the Movement’.

[^99]: James Keery, ‘The Great Tradition’, *PN Review*, 23.6 (1997),
    \<http://www.pnreview.co.uk/cgi-bin/scribe?item\_id=35\> [accessed
    28 November 2014].

[^100]: According to Davie in his admittedly partisan account, ‘Prynne’s
...
[^101]: Prynne, ‘Force of Circumstance’, in *Force of Circumstance and
...
[^102]: Aristotle, *On Interpretation*, trans. by E.M. Edghill, in *The
    Works of Aristotle*, vol. 1, ed. by W.D. Ross (Oxford: Oxford
    University Press, 1928), 19a25.

[^103]: Introducing ‘The Corn Burned by Sirius’ during a 1971 reading in
...
[^104]: For Clive Bell, a key participant, Bloomsbury was firmly in the
...
[^105]: Prynne to Dorn, 9 July 1962. That the Bloomsbury Set was
...
[^106]: Leavis, ‘Keynes, Spender and Currency-Values’, in *A Selection
...
[^107]: Q.D. Leavis, ‘The Background of Twentieth Century Letters’, in
    *A Selection from ‘Scrutiny’*, vol. 1, 162–66 [p. 165].

[^108]: Prynne to Riley, 24 April 1967; Prynne to Riley, 16 March 1969.
...
[^109]: Leavis, *Mass Civilisation and Minority Culture* (Cambridge: The
    Minority Press, 1930), pp. 14–15.

[^110]: Prynne to Dorn, 23 April 1963.

[^111]: Prynne to Diana Athill, 17 November 1964. Later in the letter,
    Prynne takes a swipe at C.P. Snow, a quintessentially Leavisian
    move.

[^112]: Prynne, ‘from a letter’, p. 28.

[^113]: Prynne, ‘Resistance and Difficulty’, *Prospect*, 5 (Winter
...
[^114]: Prynne to Olson, 8 January 1962.

[^115]: Prynne, ‘Die a Millionaire’, in *Poems*, pp. 13–16. In the lines
...
[^116]: Sutherland, ‘J.H. Prynne and Philology’, pp. 169–70.

[^117]: Prynne to Riley, 13 September 1967.

[^118]: Prynne to Riley, 13 June 1967.

[^119]: Michael Rustin, ‘Revisiting the *May Day Manifesto* of 1967–68’,
    in *May Day Manifesto 1967–68*, ed. by Raymond Williams (London:
    Lawrence & Wishart, 2013), vi–xxi (p. vi).

[^120]: *May Day Manifesto*, p. 47.

[^121]: *Ibid*., p. 50.

[^122]: Raymond Williams, ‘Our Debt to Dr. Leavis’, *Critical
    Quarterly*, 1.3 (September 1959), pp. 245–56.

[^123]: Andrew Chitty, ‘The Early Marx on Needs’, *Radical Philosophy*,
    64 (Summer 1993), 23–31 (p. 23).

[^124]: Karl Marx, *Economic and Philosophic Manuscripts of 1844*,
...
[^125]: Hilliard, pp. 56–58; Lynd, Robert S. and Helen Merrell,
    *Middletown: A Study in American Culture* (New York: Harcourt, Brace
    and Company, 1929).

[^126]: *Ibid*., pp. 180–81.

[^127]: Snow delivered the 1959 Rede Lecture at the Senate House,
...
[^128]: Leavis, ‘Revaluations (VIII): Shelley’, *Scrutiny*, 4.2 (1935),
    158–80 (p. 159).

[^129]: *Ibid*., p. 160.

[^130]: Desmond King-Hele, quoted in Roy Fuller, ‘The Osmotic Sap’,
    *Times Literary Supplement* (6 May 1971), 559–61 (p. 559);
    King-Hele, *Shelley: His Thought and Work* (London: Macmillan,
    1960), p. 216.

[^131]: F.R. Leavis, letter, *Times Literary Supplement* (21 May 1971),
    p. 593.

[^132]: Prynne, letter, *Times Literary Supplement* (28 May 1971),
    p. 620.

[^133]: *Ibid*.

[^134]: Ross Wilson, *Shelley and the Apprehension of Life* (Cambridge:
    Cambridge University Press, 2013), p. 25.

[^135]: Prynne, letter, *TLS* (28 May 1971).

[^136]: Jerome McGann, review, *Modern Philology*, 66.3 (February 1969),
    280–83 (p. 280).

[^137]: P.H. Butter, review, *Modern Language Review*, 64.2 (April
    1969), 407–08 (p. 407); Butter, review, *Modern Language Review*,
    65.4 (October 1970), 882–83 (p. 882).

[^138]: Prynne, *They That Haue Powre to Hurt; A Specimen of a
...
[^139]: William Carlos Williams, ‘Introduction to *The Wedge*’, in
    *Selected Essays* (New York: Random House, 1954), p. 256.

[^140]: Wallace Stevens, ‘Prologues to What is Possible’, *The Hudson
    Review*, 5.3 (Autumn 1952), pp. 330–31; ‘The World as Meditation’,
    *ibid*., p. 334.

[^141]: Prynne, *Concepts and Conception in Poetry* (Cambridge: Critical
    Documents, 2014), p. 40.
...
[^145]: Ian MacKillop, *F.R. Leavis: A Life in Criticism* (London: Allen
    Lane), p. 152.

[^146]: *Ibid*., p. 160.

[^147]: Leavis, *Scrutiny: A Retrospect* (Cambridge: Cambridge
...
[^148]: Prynne to Dorn, 16 June 1963.

[^149]: *Ibid*.

[^150]: *Ibid*.

[^151]: ‘The Library’s Place’, *Times Literary Supplement* (9 August
...
[^152]: Prynne, letter, *Times Literary Supplement* (16 August 1963),
    p. 629.

[^153]: Leavis, *Two Cultures?: The Significance of C.P. Snow*, ed. by
...
[^154]: *Ibid*., p. 111. Leavis’s broader views on higher education, set
...
[^155]: ‘Securing a Sustainable Future for Higher Education’ (12 October
    2010),
...
[^156]: Prynne, contribution to a discussion in the Senate House,
...
[^157]: Prynne, ‘L’Extase de M. Poher’, in *Poems*, pp. 161–62. It is
...
[^158]: The seriousness of Prynne’s commitment to the principle of
...
[^159]: Prynne to Dorn, 10 January 1972.

[^160]: ‘REF’ stands for the Research Excellence Framework, an academic
...
[^161]: Samuel Solomon, ‘Reproducing the Line: 1970s Innovative Poetry
    and Socialist-Feminism in the UK’ (unpublished doctoral thesis,
    University of Southern California, 2012), pp. 70–72.

[^162]: Prynne, ‘Tips on Reading, for Students of English’, *Gonville
    and Caius College*,
...
[^163]: Leavis, ‘A Review’, Scrutiny, 4.1 (June 1935), pp. 96–100; F.W.
...
[^164]: Davie, ‘Academicism and Jonathan Swift’, *Twentieth Century*
...
[^168]: Davie, ‘Is There a London Literary Racket?’, *Twentieth Century*
...
[^169]: *Ibid*., p. 545. Davie concludes his tirade with the
    qualification that ‘perhaps this is unfair’, but does not explain in
    what way.

[^170]: This is not to say that this principle *never* wavered; outlying
    examples such as a 1974 review written for *The Spectator* will be
    discussed further on in this thesis.

[^171]: Thomas Mallon, ‘The Underreachers’, *Contemporary Literature*,
