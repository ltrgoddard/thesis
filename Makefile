phd.pdf, phd.txt: head.markdown fron.markdown intr.markdown chap1.markdown chap2.markdown chap3.markdown conc.markdown post.markdown bibl.markdown figs.markdown figs/man.png
	...
	temp.markdown
	pandoc -s head.markdown temp.markdown -o phd.txt --filter pandoc-fignos
